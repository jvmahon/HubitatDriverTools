...
metadata {
	definition (name: "Any Z-Wave Switch Driver v1.5.6",namespace: "jvm", author: "jvm") {
...
void initialize()
{
	...
	// Create child devices if they weren't already created.
	if (state.initialized as Boolean != true )
	{
