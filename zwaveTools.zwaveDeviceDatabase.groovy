...
Map getThisDeviceDatabaseRecord() {
	...
	return localDeviceDatabase.find{ DBentry ->
...
@Field static List localDeviceDatabase = 
[
	[
		formatVersion:1,
		fingerprints: [
	...
	[
		formatVersion:1, 
		fingerprints:[[deviceType:3, name:"ThermoFloor: Heatit Z Water", deviceId:522, manufacturer:411]], 
		classVersions:[89:1, 37:1, 48:0, 38:0, 49:0, 152:0, 142:3, 0:1, 122:1, 133:2, 112:1, 134:2, 114:1, 115:1, 159:0, 90:1, 108:0, 94:1, 85:0, 96:2, 32:1],
		endpoints:[
				0:[children:[[childName:"Parent 0", namespace:"hubitat", type:"Generic Component Switch"]], 
					classes:[0, 32, 37, 38, 48, 49, 85, 89, 90, 94, 96, 108, 112, 114, 115, 122, 133, 134, 142, 152, 159]], 
				1:[children:[[childName:"Switch 1", namespace:"hubitat", type:"Generic Component Switch"]], 
					classes:[32, 37, 89, 94, 133, 142]], 
				2:[children:[[childName:"Switch 2", namespace:"hubitat", type:"Generic Component Switch"]], 
					classes:[32, 37, 89, 94, 133, 142]], 
				3:[children:[[childName:"Switch 3", namespace:"hubitat", type:"Generic Component Switch"]], 
					classes:[32, 37, 89, 94, 133, 142]], 
				4:[children:[[childName:"Switch 4", namespace:"hubitat", type:"Generic Component Switch"]], 
					classes:[32, 37, 89, 94, 133, 142]], 
				5:[children:[[childName:"Switch 5", namespace:"hubitat", type:"Generic Component Switch"]], 
					classes:[32, 37, 89, 94, 133, 142]], 
				6:[children:[[childName:"Switch 6", namespace:"hubitat", type:"Generic Component Switch"]], 
					classes:[32, 37, 89, 94, 133, 142]], 
				7:[children:[[childName:"Switch 7", namespace:"hubitat", type:"Generic Component Switch"]], 
					classes:[32, 37, 89, 94, 133, 142]], 
				8:[children:[[childName:"Switch 8", namespace:"hubitat", type:"Generic Component Switch"]], 
					classes:[32, 37, 89, 94, 133, 142]], 
				9:[children:[[childName:"Switch 9", namespace:"hubitat", type:"Generic Component Switch"]], 
					classes:[32, 37, 89, 94, 133, 142]], 
				10:[children:[[childName:"Switch 10", namespace:"hubitat", type:"Generic Component Switch"]], 
					classes:[32, 37, 89, 94, 133, 142]],
				11:[children:[[childName:"Sensor 11", namespace:"hubitat", type:"Generic Component Temperature Sensor"]], 
					classes:[32, 49, 89, 94, 133, 142]], 
				12:[children:[[childName:"Sensor 12", namespace:"hubitat", type:"Generic Component Temperature Sensor"]], 
					classes:[32, 49, 89, 94, 133, 142]],
				13:[children:[[childName:"Sensor 13", namespace:"hubitat", type:"Generic Component Temperature Sensor"]], 
					classes:[32, 49, 89, 94, 133, 142]], 
				14:[children:[[childName:"Sensor 14", namespace:"hubitat", type:"Generic Component Temperature Sensor"]], 
					classes:[32, 49, 89, 94, 133, 142]], 
			], 
		deviceInputs:[
				1:[size:1, name:1, options:[0:"LED turned off.", 1:"LED turned on. (Default)", 2:"LED flashing at 1 second intervals (½ Hz)", 3:"LED flashing at ½ second interval (1 Hz)"], description:"Configuration of the status LED", title:"(1) Status LED", type:"enum"], 
				2:[size:1, name:2, description:"Configure the percentage of light in the status LED, when the LED is turned on", range:"0..100", title:"(2) LED brightness", type:"number"], 
				3:[size:1, name:3, options:[0:"No thermistor, input is disabled. (Default)", 1:"10K NTC. (PART NUMBER: TT02-10KC3-93D-3000R-TPH)"], description:"This parameter decides which kind of thermistor that is connected to the input.", title:"(3) Thermistor type input 11", type:"enum"], 
				4:[size:1, name:4, options:[0:"No thermistor, input is disabled. (Default)", 1:"10K NTC. (PART NUMBER: TT02-10KC3-93D-3000R-TPH)"], description:"This parameter decides which kind of thermistor that is connected to the input.", title:"(4) Thermistor type input 12", type:"enum"], 
				5:[size:1, name:5, options:[0:"No thermistor, input is disabled. (Default)", 1:"10K NTC. (PART NUMBER: TT02-10KC3-93D-3000R-TPH)"], description:"This parameter decides which kind of thermistor that is connected to the input.", title:"(5) Thermistor type input 13", type:"enum"], 
				6:[size:1, name:6, options:[0:"No thermistor, input is disabled. (Default)", 1:"10K NTC. (PART NUMBER: TT02-10KC3-93D-3000R-TPH)"], description:"This parameter decides which kind of thermistor that is connected to the input.", title:"(6) Thermistor type input 14", type:"enum"], 
				7:[size:1, name:7, range:"-40..40", title:"(7) Input 11 calibration", type:"number"], 
				8:[size:1, name:8, description:"Input 12 calibration", range:"-40..40", title:"(8) Input 12 calibration", type:"number"], 
				9:[size:1, name:9, range:"-40..40", title:"(9) Input 13 calibration", type:"number"], 
				10:[size:1, name:10, range:"-40..40", title:"(10) Input 14 calibration", type:"number"],
				11:[size:2, name:11, description:"Time interval between consecutive temperature reports.", range:"0..8640", title:"(11) Input 1 report interval", type:"number"], 
				12:[size:2, name:12, description:"Time interval between consecutive temperature reports.", range:"0..8640", title:"(12) Input 2 report interval", type:"number"], 
				13:[size:2, name:13, description:"Time interval between consecutive temperature reports.", range:"0..8640", title:"(13) Input 3 report interval", type:"number"], 
				14:[size:2, name:14, description:"Time interval between consecutive temperature reports.", range:"0..8640", title:"(14) Input 4 report interval", type:"number"],
				]
	], 
]
