...
metadata {
	definition (name: "Any Z-Wave Device Universal Parent Driver v1.7.4",namespace: "jvm", author: "jvm", singleThreaded:false) {
...
[ // library marker zwaveTools.zwaveDeviceDatabase, line 29
	...
	[ // library marker zwaveTools.zwaveDeviceDatabase, line 364
		...
		deviceInputs:[ // library marker zwaveTools.zwaveDeviceDatabase, line 400
				...
				4:[size:1, name:4, options:[0:"No thermistor, input is disabled. (Default)", 1:"10K NTC. (PART NUMBER: TT02-10KC3-93D-3000R-TPH)]", description:"This parameter decides which kind of thermistor that is connected to the input.", title:"(3) Thermistor type input 12", type:"enum"]],  // library marker zwaveTools.zwaveDeviceDatabase, line 404
				5:[size:1, name:5, options:[0:"No thermistor, input is disabled. (Default)", 1:"10K NTC. (PART NUMBER: TT02-10KC3-93D-3000R-TPH)]", description:"This parameter decides which kind of thermistor that is connected to the input.", title:"(3) Thermistor type input 13", type:"enum"]],  // library marker zwaveTools.zwaveDeviceDatabase, line 405
				6:[size:1, name:6, options:[0:"No thermistor, input is disabled. (Default)", 1:"10K NTC. (PART NUMBER: TT02-10KC3-93D-3000R-TPH)]", description:"This parameter decides which kind of thermistor that is connected to the input.", title:"(3) Thermistor type input 14", type:"enum"]],  // library marker zwaveTools.zwaveDeviceDatabase, line 406
				...
				8:[size:1, name:8, description:"Input 12 calibration", range:"-40..40", title:"(8) Input 2 calibration", type:"number"],  // library marker zwaveTools.zwaveDeviceDatabase, line 408
