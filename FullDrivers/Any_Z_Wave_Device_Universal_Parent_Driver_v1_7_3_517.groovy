...
metadata {
	definition (name: "Any Z-Wave Device Universal Parent Driver v1.7.3",namespace: "jvm", author: "jvm", singleThreaded:false) {
...
[ // library marker zwaveTools.zwaveDeviceDatabase, line 29
	...
	[ // library marker zwaveTools.zwaveDeviceDatabase, line 300
		...
		deviceInputs:[ // library marker zwaveTools.zwaveDeviceDatabase, line 313
			...
			8:[name:'8', title:'(8) Auto Turn-Off Timer for Dimmer (minutes)', size:4, type:'number', range:"0..65535"],  // library marker zwaveTools.zwaveDeviceDatabase, line 321
			9:[name:'9', title:'(9) Auto Turn-On Timer for Dimmer (minutes)', size:4, type:'number', range:"0..65535"],  // library marker zwaveTools.zwaveDeviceDatabase, line 322
			10:[name:'10', title:'(10) Auto Turn-Off Timer for Relay (minutes)', size:4, type:'number', range:"0..65535"],  // library marker zwaveTools.zwaveDeviceDatabase, line 323
			11:[name:'11', title:'(11) Auto Turn-On Timer for Relay (minutes)', size:4, type:'number', range:"0..65535"],  // library marker zwaveTools.zwaveDeviceDatabase, line 324
			...
			13:[name:'13', title:'(13) Ramp Rate Control for Dimmer (seconds)', size:1, type:'number', range:"0..99"],  // library marker zwaveTools.zwaveDeviceDatabase, line 326
	...
	[ // library marker zwaveTools.zwaveDeviceDatabase, line 338
		...
		deviceInputs: [ // library marker zwaveTools.zwaveDeviceDatabase, line 350
			...
			11:[size:1, name:"11", description:"Lock Specific Alarm Disable Local Controls", options:[0:"Disable Local Control", 255:"Enable Local Control"], title:"(11) Alarm Disable Local Controls", type:"enum"],  // library marker zwaveTools.zwaveDeviceDatabase, line 358
			15:[size:1, name:"15", description:"Automatically throws the deadbolt 30 after seconds", options:[0:"Disable Auto Lock", 255:"Enable Auto Lock"], title:"(15) Auto Lock", type:"enum"],  // library marker zwaveTools.zwaveDeviceDatabase, line 359
			16:[size:1, name:"16", description:"Required length of all User Codes", options:[4:"4", 5:"5", 6:"6", 7:"7", 8:"8"], title:"(16) User Code PIN Length", type:"enum"] // library marker zwaveTools.zwaveDeviceDatabase, line 360
		],  // library marker zwaveTools.zwaveDeviceDatabase, line 361
	] // library marker zwaveTools.zwaveDeviceDatabase, line 362
...
{ // library marker zwaveTools.sensorTools, line 76
	...
	if (tempReport) { // library marker zwaveTools.sensorTools, line 95
		tempReport.value = convertTemperatureIfNeeded(cmd.scaledMeterValue, ((((int) cmd.scale ) == 0) ? "C" : "F"), 2) // library marker zwaveTools.sensorTools, line 96
	...
	Map otherSensorReport = [ // library marker zwaveTools.sensorTools, line 100
		3000:[name: "illuminance", value: cmd.scaledMeterValue, unit: "%"], // Illuminance // library marker zwaveTools.sensorTools, line 101
		3001:[name: "illuminance", value: cmd.scaledMeterValue, unit: "lx"], // library marker zwaveTools.sensorTools, line 102
		4000:[name: "power", value: cmd.scaledMeterValue, unit: "W"], // library marker zwaveTools.sensorTools, line 103
		4001:[name: "power", value: cmd.scaledMeterValue, unit: "BTU/h"], // library marker zwaveTools.sensorTools, line 104
		5000:[name: "humidity", value: cmd.scaledMeterValue, unit: "%"], // library marker zwaveTools.sensorTools, line 105
		5001:[name: "humidity", value: cmd.scaledMeterValue, unit: "g/m3"], // library marker zwaveTools.sensorTools, line 106
		8000:[name: "pressure", value: (cmd.scaledMeterValue * ((cmd.scale == 0) ? 1000 : 3386.38867)), unit:"Pa", descriptionText:"Atmospheric Pressure"], // library marker zwaveTools.sensorTools, line 107
		9000:[name: "pressure", value: (cmd.scaledMeterValue * ((cmd.scale == 0) ? 1000 : 3386.38867)), unit:"Pa", descriptionText:"Barometric Pressure"], // library marker zwaveTools.sensorTools, line 108
		15000:[name: "voltage", value: cmd.scaledMeterValue, unit: "V"], // library marker zwaveTools.sensorTools, line 109
		15001:[name: "voltage", value: cmd.scaledMeterValue, unit: "mV"], // library marker zwaveTools.sensorTools, line 110
		16000:[name: "amperage", value: cmd.scaledMeterValue, unit: "A"], // library marker zwaveTools.sensorTools, line 111
		16001:[name: "amperage", value: cmd.scaledMeterValue, unit: "mA"], // library marker zwaveTools.sensorTools, line 112
		17000:[name: "carbonDioxide ", value: cmd.scaledMeterValue, unit: "ppm"], // library marker zwaveTools.sensorTools, line 113
		27000:[name: "ultravioletIndex", value: cmd.scaledMeterValue, unit: "UV Index"], // library marker zwaveTools.sensorTools, line 114
		40000:[name: "carbonMonoxide ", value: cmd.scaledMeterValue, unit: "ppm"], // library marker zwaveTools.sensorTools, line 115
		56000:[name: "rate", value: cmd.scaledMeterValue, unit: "LPH"], // Water flow	 // library marker zwaveTools.sensorTools, line 116
		58000:[name: "rssi", value: cmd.scaledMeterValue, unit: "%"], // library marker zwaveTools.sensorTools, line 117
		58001:[name: "rssi", value: cmd.scaledMeterValue, unit: "dBm"], // library marker zwaveTools.sensorTools, line 118
		67000:[name: "pH", value: cmd.scaledMeterValue, unit: "pH"], // library marker zwaveTools.sensorTools, line 119
