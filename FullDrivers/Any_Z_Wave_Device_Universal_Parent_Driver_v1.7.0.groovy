...
void parse(String description) { // library marker zwaveTools.sendReceiveTools, line 42
	try{ // library marker zwaveTools.sendReceiveTools, line 43
	...
	} catch (Exception ex) { // library marker zwaveTools.sendReceiveTools, line 46
		log.error "Device ${device.displayName}: An Error occurred when attempting to parse ${description}. Error is: ${getExceptionmessageWithLine(ex)}" // library marker zwaveTools.sendReceiveTools, line 47
	} // library marker zwaveTools.sendReceiveTools, line 48
} // library marker zwaveTools.sendReceiveTools, line 49



void parse(List<Map> listOfEvents) { // library marker zwaveTools.sendReceiveTools, line 53
    listOfEvents.each { // library marker zwaveTools.sendReceiveTools, line 54
        if (device.hasAttribute(it.name)) { // library marker zwaveTools.sendReceiveTools, line 55
            if (txtEnable && it.descriptionText) log.info it.descriptionText // library marker zwaveTools.sendReceiveTools, line 56
            sendEvent(it) // library marker zwaveTools.sendReceiveTools, line 57
        } // library marker zwaveTools.sendReceiveTools, line 58
    } // library marker zwaveTools.sendReceiveTools, line 59
} // library marker zwaveTools.sendReceiveTools, line 60

String secure(hubitat.zwave.Command cmd, Integer ep = null ){  // library marker zwaveTools.sendReceiveTools, line 62
	if (ep) { // library marker zwaveTools.sendReceiveTools, line 63
		return zwaveSecureEncap(zwave.multiChannelV4.multiChannelCmdEncap(sourceEndPoint: 0, bitAddress: 0, res01:0, destinationEndPoint: ep).encapsulate(cmd)) // library marker zwaveTools.sendReceiveTools, line 64
	} else { // library marker zwaveTools.sendReceiveTools, line 65
		return zwaveSecureEncap(cmd)  // library marker zwaveTools.sendReceiveTools, line 66
	} // library marker zwaveTools.sendReceiveTools, line 67
} // library marker zwaveTools.sendReceiveTools, line 68

// a simple unsupervised send with endpoint support // library marker zwaveTools.sendReceiveTools, line 70
void basicZwaveSend(hubitat.zwave.Command cmd, Integer ep = null ) {  // library marker zwaveTools.sendReceiveTools, line 71
	sendHubCommand(new hubitat.device.HubAction( secure(cmd, ep), hubitat.device.Protocol.ZWAVE))  // library marker zwaveTools.sendReceiveTools, line 72
} // library marker zwaveTools.sendReceiveTools, line 73

////    Security Encapsulation   //// // library marker zwaveTools.sendReceiveTools, line 75
void zwaveEvent(hubitat.zwave.commands.securityv1.SecurityMessageEncapsulation cmd) { // library marker zwaveTools.sendReceiveTools, line 76
	hubitat.zwave.Command encapsulatedCommand = cmd.encapsulatedCommand( (userParseMap ?: defaultParseMap) ) // library marker zwaveTools.sendReceiveTools, line 77
    if (encapsulatedCommand) { zwaveEvent(encapsulatedCommand) } // library marker zwaveTools.sendReceiveTools, line 78
} // library marker zwaveTools.sendReceiveTools, line 79

////    Multi-Channel Encapsulation   //// // library marker zwaveTools.sendReceiveTools, line 81
void zwaveEvent(hubitat.zwave.commands.multichannelv4.MultiChannelCmdEncap cmd) { // library marker zwaveTools.sendReceiveTools, line 82
    hubitat.zwave.Command  encapsulatedCommand = cmd.encapsulatedCommand((userParseMap ?: defaultParseMap)) // library marker zwaveTools.sendReceiveTools, line 83
    if (encapsulatedCommand) { zwaveEvent(encapsulatedCommand, cmd.sourceEndPoint) } // library marker zwaveTools.sendReceiveTools, line 84
} // library marker zwaveTools.sendReceiveTools, line 85


//// Catch Event Not Otherwise Handled! ///// // library marker zwaveTools.sendReceiveTools, line 88
void zwaveEvent(hubitat.zwave.Command cmd, Integer ep = null ) { // library marker zwaveTools.sendReceiveTools, line 89
    log.warn "Device ${device.displayName}: Received Z-Wave Message ${cmd} that is not handled by this driver. Endpoint: ${ep ?: 0}. Message class: ${cmd.class}." // library marker zwaveTools.sendReceiveTools, line 90
} // library marker zwaveTools.sendReceiveTools, line 91

////////////////////////////////////////////////////////////////////// // library marker zwaveTools.sendReceiveTools, line 93
//////        Handle Supervision request and reports           /////// // library marker zwaveTools.sendReceiveTools, line 94
//////////////////////////////////////////////////////////////////////  // library marker zwaveTools.sendReceiveTools, line 95

// @Field static results in variable being shared among all devices that use the same driver, so I use a concurrentHashMap keyed by a device's deviceNetworkId to get a unqiue value for a particular device // library marker zwaveTools.sendReceiveTools, line 97
// supervisionSessionIDs stores the last used sessionID value (0..63) for a device. It must be incremented mod 64 on each send // library marker zwaveTools.sendReceiveTools, line 98
// supervisionSentCommands stores the last command sent // library marker zwaveTools.sendReceiveTools, line 99
// Each is initialized for 64 devices, but can automatically grow // library marker zwaveTools.sendReceiveTools, line 100
@Field static ConcurrentHashMap<String, Integer> supervisionSessionIDs = new ConcurrentHashMap<String, Integer>(64, 0.75, 1) // library marker zwaveTools.sendReceiveTools, line 101
@Field static ConcurrentHashMap<String, ConcurrentHashMap> supervisionSentCommands = new ConcurrentHashMap<String, ConcurrentHashMap<Integer, String>>(64, 0.75, 1) // library marker zwaveTools.sendReceiveTools, line 102

Integer getNewSessionId() { // library marker zwaveTools.sendReceiveTools, line 104
		// Get the next session ID mod 64, but if there is no stored session ID, initialize it with a random value. // library marker zwaveTools.sendReceiveTools, line 105
		Integer lastSessionID = supervisionSessionIDs.get(device.getDeviceNetworkId() ,((Integer)(Math.random() * 64) % 64)  ) // library marker zwaveTools.sendReceiveTools, line 106
		Integer nextSessionID = (lastSessionID + 1) % 64 // increment and then mod with 64, and then store it back in the Hash table. // library marker zwaveTools.sendReceiveTools, line 107
		supervisionSessionIDs.replace(device.getDeviceNetworkId(), nextSessionID) // library marker zwaveTools.sendReceiveTools, line 108
		return nextSessionID // library marker zwaveTools.sendReceiveTools, line 109
}  // library marker zwaveTools.sendReceiveTools, line 110

Boolean getNeverSupervise() // library marker zwaveTools.sendReceiveTools, line 112
{ // library marker zwaveTools.sendReceiveTools, line 113
	Integer mfr = 			getDataValue("manufacturer")?.toInteger() // library marker zwaveTools.sendReceiveTools, line 114
	Integer deviceId = 		getDataValue("deviceId")?.toInteger() // library marker zwaveTools.sendReceiveTools, line 115
	Integer deviceType =	getDataValue("deviceType")?.toInteger() // library marker zwaveTools.sendReceiveTools, line 116
	List<Map> supervisionBroken = [ // library marker zwaveTools.sendReceiveTools, line 117
			[	manufacturer:798,  	deviceType:14,	deviceId: 1  	], // Inovelli LZW36 firmware 1.36 supervision is broken! // library marker zwaveTools.sendReceiveTools, line 118
			]  // library marker zwaveTools.sendReceiveTools, line 119
	if (userSupervisionBrokenMap) {supervisionBroken += userSupervisionBrokenMap} // library marker zwaveTools.sendReceiveTools, line 120

	Map thisDevice =	supervisionBroken.find{ ((it.manufacturer == mfr ) && (it.deviceId == deviceId ) && (it.deviceType == deviceType)) } // library marker zwaveTools.sendReceiveTools, line 122

	if (thisDevice && logEnable) log.warn "Device ${device.displayName}: This device is on the Never Supervise list. Check manufacturer for a firmware update. Not supervising." // library marker zwaveTools.sendReceiveTools, line 124
	return ( thisDevice ? true : false ) // library marker zwaveTools.sendReceiveTools, line 125
} // library marker zwaveTools.sendReceiveTools, line 126

Boolean ignoreSupervisionNoSupportCode() // library marker zwaveTools.sendReceiveTools, line 128
{ // library marker zwaveTools.sendReceiveTools, line 129
	// Some devices implement the Supervision command class incorrectly and return a "No Support" code even when they work. // library marker zwaveTools.sendReceiveTools, line 130
	// This function is to ignore the No Support code from those devices. // library marker zwaveTools.sendReceiveTools, line 131
	Integer mfr = 			getDataValue("manufacturer")?.toInteger() // library marker zwaveTools.sendReceiveTools, line 132
	Integer deviceId = 		getDataValue("deviceId")?.toInteger() // library marker zwaveTools.sendReceiveTools, line 133
	Integer deviceType =	getDataValue("deviceType")?.toInteger() // library marker zwaveTools.sendReceiveTools, line 134
	List<Map> poorSupervisionSupport = [ // library marker zwaveTools.sendReceiveTools, line 135
			[	manufacturer:12,  	deviceType:17479,	deviceId: 12340  	], // HomeSeer WD100 S2 is buggy! // library marker zwaveTools.sendReceiveTools, line 136
			[	manufacturer:12,  	deviceType:17479,	deviceId: 12342  	], // HomeSeer WD200 is buggy! // library marker zwaveTools.sendReceiveTools, line 137
			] // library marker zwaveTools.sendReceiveTools, line 138

	if (userPoorSupervisionSupportMap) {poorSupervisionSupport += userPoorSupervisionSupportMap} // library marker zwaveTools.sendReceiveTools, line 140

    Map thisDevice =	poorSupervisionSupport.find{((it.manufacturer == mfr ) && (it.deviceId == deviceId ) && (it.deviceType == deviceType)) } // library marker zwaveTools.sendReceiveTools, line 142
	if (thisDevice && logEnable) log.warn "Device ${device.displayName}: This device is on the Poor Supervise Support list. Check manufacturer for a firmware update. Ignoring 'No Support' return codes." // library marker zwaveTools.sendReceiveTools, line 143

		return ( thisDevice ? true : false )				 // library marker zwaveTools.sendReceiveTools, line 145
} // library marker zwaveTools.sendReceiveTools, line 146

Boolean getSuperviseThis() { // library marker zwaveTools.sendReceiveTools, line 148
		if (neverSupervise) return false // library marker zwaveTools.sendReceiveTools, line 149
		return (getDataValue("S2")?.toInteger() != null ) // library marker zwaveTools.sendReceiveTools, line 150
} // library marker zwaveTools.sendReceiveTools, line 151

void advancedZwaveSend(Map inputs = [:]) {  // library marker zwaveTools.sendReceiveTools, line 153
	Map params = [ cmd: null , onSuccess: null , onFailure: null , delay: null , ep: null ] // library marker zwaveTools.sendReceiveTools, line 154
	params << inputs // library marker zwaveTools.sendReceiveTools, line 155
	List<String> superviseThese = [ "2501", // Switch Binary // library marker zwaveTools.sendReceiveTools, line 156
									"2601", "2604", "2605", //  Switch MultiLevel  // library marker zwaveTools.sendReceiveTools, line 157
									"7601", // Lock V1 // library marker zwaveTools.sendReceiveTools, line 158
									"3305", // Switch Color Set									 // library marker zwaveTools.sendReceiveTools, line 159
									] // library marker zwaveTools.sendReceiveTools, line 160
	if (userDefinedSupervisionList) superviseThese += userDefinedSupervisionList								 // library marker zwaveTools.sendReceiveTools, line 161
	if (superviseThese.contains(params.cmd.CMD)) { // library marker zwaveTools.sendReceiveTools, line 162
		sendSupervised(params) // library marker zwaveTools.sendReceiveTools, line 163
	} else { // library marker zwaveTools.sendReceiveTools, line 164
		sendUnsupervised(params) // library marker zwaveTools.sendReceiveTools, line 165
	} // library marker zwaveTools.sendReceiveTools, line 166
} // library marker zwaveTools.sendReceiveTools, line 167
void advancedZwaveSend(hubitat.zwave.Command cmd, Integer ep = null ) {  // library marker zwaveTools.sendReceiveTools, line 168
	advancedZwaveSend(cmd:cmd, ep:ep) // library marker zwaveTools.sendReceiveTools, line 169
} // library marker zwaveTools.sendReceiveTools, line 170

void sendSupervised(hubitat.zwave.Command cmd, Integer ep = null ) {  // library marker zwaveTools.sendReceiveTools, line 172
    sendSupervised(cmd:cmd, ep:ep) // library marker zwaveTools.sendReceiveTools, line 173
} // library marker zwaveTools.sendReceiveTools, line 174

void sendSupervised(Map inputs = [:]) {  // library marker zwaveTools.sendReceiveTools, line 176
	Map params = [ cmd: null , onSuccess: null , onFailure: null , delay: null , ep: null ] // library marker zwaveTools.sendReceiveTools, line 177
	params << inputs // library marker zwaveTools.sendReceiveTools, line 178
	if (!(params.cmd instanceof hubitat.zwave.Command )) {  // library marker zwaveTools.sendReceiveTools, line 179
		log.error "SendSupervised called with improper command type" // library marker zwaveTools.sendReceiveTools, line 180
		return  // library marker zwaveTools.sendReceiveTools, line 181
		} // library marker zwaveTools.sendReceiveTools, line 182
	if (params.onSuccess && !(params.onSuccess instanceof hubitat.zwave.Command )) {  // library marker zwaveTools.sendReceiveTools, line 183
		log.error "SendSupervised called with improper onSuccess command type" // library marker zwaveTools.sendReceiveTools, line 184
		return  // library marker zwaveTools.sendReceiveTools, line 185
		} // library marker zwaveTools.sendReceiveTools, line 186
	if (params.onFailure && !(params.onFailure instanceof hubitat.zwave.Command )) {  // library marker zwaveTools.sendReceiveTools, line 187
		log.error "SendSupervised called with improper onFailure command type" // library marker zwaveTools.sendReceiveTools, line 188
		return  // library marker zwaveTools.sendReceiveTools, line 189
		} // library marker zwaveTools.sendReceiveTools, line 190

	if (superviseThis) { // library marker zwaveTools.sendReceiveTools, line 192
		Integer thisSessionId = getNewSessionId() // library marker zwaveTools.sendReceiveTools, line 193
		ConcurrentHashMap commandStorage = supervisionSentCommands.get(device.getDeviceNetworkId() , new ConcurrentHashMap<Integer, hubitat.zwave.Command>(64, 0.75, 1)) // library marker zwaveTools.sendReceiveTools, line 194

		hubitat.zwave.Command  supervisedCommand = zwave.supervisionV1.supervisionGet(sessionID: thisSessionId, statusUpdates: true ).encapsulate(params.cmd) // library marker zwaveTools.sendReceiveTools, line 196

		commandStorage.put(thisSessionId, [cmd:(params.cmd), onSuccess: (params.onSuccess), onFailure:(params.onFailure), ep:(params.ep), attempt:1, sessionId:thisSessionId])  // library marker zwaveTools.sendReceiveTools, line 198

		basicZwaveSend(supervisedCommand, ep)	 // library marker zwaveTools.sendReceiveTools, line 200

		Integer retryTime	=  Math.min( Math.max( (s2RetryPeriod ?: 2000), 500), 5000) // library marker zwaveTools.sendReceiveTools, line 202
		runInMillis( retryTime, supervisionCheck)	 // library marker zwaveTools.sendReceiveTools, line 203

	} else { // library marker zwaveTools.sendReceiveTools, line 205
		basicZwaveSend(params.cmd, params.ep) // library marker zwaveTools.sendReceiveTools, line 206
	} // library marker zwaveTools.sendReceiveTools, line 207
} // library marker zwaveTools.sendReceiveTools, line 208
void sendUnsupervised(hubitat.zwave.Command cmd, Integer ep = null ) {  // library marker zwaveTools.sendReceiveTools, line 209
	basicZwaveSend(cmd, ep) // library marker zwaveTools.sendReceiveTools, line 210
} // library marker zwaveTools.sendReceiveTools, line 211
void sendUnsupervised(Map inputs = [:]) {  // library marker zwaveTools.sendReceiveTools, line 212
	Map params = [ cmd: null , onSuccess: null , onFailure: null , delay: null , ep: null ] // library marker zwaveTools.sendReceiveTools, line 213
	params << inputs // library marker zwaveTools.sendReceiveTools, line 214
	basicZwaveSend(params.cmd, params.ep) // library marker zwaveTools.sendReceiveTools, line 215
} // library marker zwaveTools.sendReceiveTools, line 216

// This handles a supervised message (a "get") received from the Z-Wave device // // library marker zwaveTools.sendReceiveTools, line 218
void zwaveEvent(hubitat.zwave.commands.supervisionv1.SupervisionGet cmd, Integer ep = null ) { // library marker zwaveTools.sendReceiveTools, line 219
    hubitat.zwave.Command encapsulatedCommand = cmd.encapsulatedCommand((userParseMap ?: defaultParseMap)) // library marker zwaveTools.sendReceiveTools, line 220

    if (encapsulatedCommand) { // library marker zwaveTools.sendReceiveTools, line 222
		if ( ep ) { // library marker zwaveTools.sendReceiveTools, line 223
			zwaveEvent(encapsulatedCommand, ep) // library marker zwaveTools.sendReceiveTools, line 224
		} else { // library marker zwaveTools.sendReceiveTools, line 225
			zwaveEvent(encapsulatedCommand) // library marker zwaveTools.sendReceiveTools, line 226
		} // library marker zwaveTools.sendReceiveTools, line 227
    } // library marker zwaveTools.sendReceiveTools, line 228

	basicZwaveSend( new hubitat.zwave.commands.supervisionv1.SupervisionReport(sessionID: cmd.sessionID, reserved: 0, moreStatusUpdates: false, status: 0xFF, duration: 0), ep) // library marker zwaveTools.sendReceiveTools, line 230
} // library marker zwaveTools.sendReceiveTools, line 231

void zwaveEvent(hubitat.zwave.commands.supervisionv1.SupervisionReport cmd, Integer ep = null )  // library marker zwaveTools.sendReceiveTools, line 233
{ // library marker zwaveTools.sendReceiveTools, line 234
	ConcurrentHashMap whatThisDeviceSent = supervisionSentCommands?.get(device.getDeviceNetworkId() ) // library marker zwaveTools.sendReceiveTools, line 235

	Map whatWasSent = whatThisDeviceSent?.get((Integer) cmd.sessionID) // library marker zwaveTools.sendReceiveTools, line 237

    if (!whatWasSent) { // library marker zwaveTools.sendReceiveTools, line 239
        log.warn "Device ${device.displayName}: Received SuperVision Report ${cmd} for endpoint ${ep},  but what was sent is null. May have been processed by a duplicate SuperVision Report. If this happens repeatedly, report issue at https://github.com/jvmahon/HubitatDriverTools/issues" // library marker zwaveTools.sendReceiveTools, line 240
        return // library marker zwaveTools.sendReceiveTools, line 241
    } // library marker zwaveTools.sendReceiveTools, line 242

	switch ((Integer) cmd.status) // library marker zwaveTools.sendReceiveTools, line 244
	{ // library marker zwaveTools.sendReceiveTools, line 245
		case 0x00: // "No Support"  // library marker zwaveTools.sendReceiveTools, line 246
			whatWasSent = whatThisDeviceSent?.remove((Integer)cmd.sessionID) // library marker zwaveTools.sendReceiveTools, line 247
			if (ignoreSupervisionNoSupportCode()) { // library marker zwaveTools.sendReceiveTools, line 248
                if (logEnable) log.warn "Device ${device.displayName}: Received a 'No Support' supervision report ${cmd} for command ${whatWasSent}, but this device has known problems with its Supervision implementation so the 'No Support' code was ignored." // library marker zwaveTools.sendReceiveTools, line 249
				if (whatWasSent.onSuccess) basicZwaveSend(whatWasSent.onSuccess, whatWasSent.ep)  // library marker zwaveTools.sendReceiveTools, line 250

			} else 	{ // library marker zwaveTools.sendReceiveTools, line 252
				log.warn "Device ${device.displayName}: Z-Wave Command supervision reported as 'No Support' for command ${whatWasSent}. If you see this warning repeatedly, please report as an issue at https://github.com/jvmahon/HubitatDriverTools/issues. Please provide the manufacturer, deviceType, and deviceId code for your device as shown on the device's Hubitat device web page." // library marker zwaveTools.sendReceiveTools, line 253
				if (whatWasSent.onFailure) basicZwaveSend(whatWasSent.onFailure, whatWasSent.ep)  // library marker zwaveTools.sendReceiveTools, line 254
			} // library marker zwaveTools.sendReceiveTools, line 255
			break // library marker zwaveTools.sendReceiveTools, line 256
		case 0x01: // "working" - Remove check if you get back a "working" status since you know device is processing the command. // library marker zwaveTools.sendReceiveTools, line 257
			whatWasSent = whatThisDeviceSent?.get((Integer)cmd.sessionID) // library marker zwaveTools.sendReceiveTools, line 258
			if (txtEnable) log.info "Device ${device.displayName}: Still processing command: ${whatWasSent}." // library marker zwaveTools.sendReceiveTools, line 259
			runInMillis(5000, supervisionCheck)	 // library marker zwaveTools.sendReceiveTools, line 260
			break ; // library marker zwaveTools.sendReceiveTools, line 261
		case 0x02: // "Fail" // library marker zwaveTools.sendReceiveTools, line 262
			whatWasSent = whatThisDeviceSent?.remove((Integer) cmd.sessionID) // library marker zwaveTools.sendReceiveTools, line 263
			log.warn "Device ${device.displayName}: Z-Wave supervised command reported failure. Failed command: ${whatWasSent}." // library marker zwaveTools.sendReceiveTools, line 264
			if (whatWasSent.onFailure) basicZwaveSend(whatWasSent.onFailure, whatWasSent.ep)  // library marker zwaveTools.sendReceiveTools, line 265

			break // library marker zwaveTools.sendReceiveTools, line 267
		case 0xFF: // "Success" // library marker zwaveTools.sendReceiveTools, line 268
			whatWasSent = whatThisDeviceSent?.remove((Integer) cmd.sessionID) // library marker zwaveTools.sendReceiveTools, line 269
			if (txtEnable || logEnable) log.info "Device ${device.displayName}: Device successfully processed supervised command ${whatWasSent}." // library marker zwaveTools.sendReceiveTools, line 270
			if (whatWasSent.onSuccess) basicZwaveSend(whatWasSent.onSuccess, whatWasSent.ep)  // library marker zwaveTools.sendReceiveTools, line 271
			break // library marker zwaveTools.sendReceiveTools, line 272
	} // library marker zwaveTools.sendReceiveTools, line 273
	if (whatThisDeviceSent?.size() < 1) unschedule(supervisionCheck) // library marker zwaveTools.sendReceiveTools, line 274
} // library marker zwaveTools.sendReceiveTools, line 275

void supervisionCheck() { // library marker zwaveTools.sendReceiveTools, line 277
    // re-attempt supervision once, else send without supervision // library marker zwaveTools.sendReceiveTools, line 278
	ConcurrentHashMap tryAgain = supervisionSentCommands?.get(device.getDeviceNetworkId()) // library marker zwaveTools.sendReceiveTools, line 279
	tryAgain?.each{ thisSessionId, whatWasSent -> // library marker zwaveTools.sendReceiveTools, line 280

		Integer retries = Math.min( Math.max( (s2MaxRetries ?: 2), 1), 5) // library marker zwaveTools.sendReceiveTools, line 282
		if (whatWasSent.attempt <  retries ) { // library marker zwaveTools.sendReceiveTools, line 283
			whatWasSent.attempt += 1 // library marker zwaveTools.sendReceiveTools, line 284
			hubitat.zwave.Command  supervisedCommand = zwave.supervisionV1.supervisionGet(sessionID: thisSessionId, statusUpdates: true ).encapsulate(whatWasSent.cmd) // library marker zwaveTools.sendReceiveTools, line 285
			log.info "Device ${device.displayName}: Supervised command failed to respond. Reattempting command ${whatWasSent}." // library marker zwaveTools.sendReceiveTools, line 286

			basicZwaveSend(supervisedCommand, whatWasSent.ep)	 // library marker zwaveTools.sendReceiveTools, line 288
		} else { // library marker zwaveTools.sendReceiveTools, line 289
			if (logEnable) log.debug "Device ${device.displayName}: Supervision command retries exceeded. Resending command without supervision. Command ${whatWasSent}." // library marker zwaveTools.sendReceiveTools, line 290
			basicZwaveSend(whatWasSent.cmd, whatWasSent.ep) // library marker zwaveTools.sendReceiveTools, line 291
			supervisionSentCommands?.get(device.getDeviceNetworkId()).remove((Integer) thisSessionId)		 // library marker zwaveTools.sendReceiveTools, line 292
		} // library marker zwaveTools.sendReceiveTools, line 293
	} // library marker zwaveTools.sendReceiveTools, line 294
} // library marker zwaveTools.sendReceiveTools, line 295
...
[ // library marker zwaveTools.zwaveDeviceDatabase, line 29
	...
	[ // library marker zwaveTools.zwaveDeviceDatabase, line 74
		...
		deviceInputs:[ // library marker zwaveTools.zwaveDeviceDatabase, line 86
			...
			7:[ size:1,	category:"basic", name:"7", title:"(7) Remote Dimming Level Increment", range:"1..99", type:"number"], // library marker zwaveTools.zwaveDeviceDatabase, line 89
			...
			9:[ size:1,	category:"basic", name:"9", title:"(9) Local Dimming Level Increment", range:"1..99", type:"number"], // library marker zwaveTools.zwaveDeviceDatabase, line 91
	...
	[ // library marker zwaveTools.zwaveDeviceDatabase, line 336
		formatVersion:1,  // library marker zwaveTools.zwaveDeviceDatabase, line 337
		fingerprints:[ // library marker zwaveTools.zwaveDeviceDatabase, line 338
				[deviceType:1, name:"Allegion: BE469ZP", deviceId:1129, manufacturer:59] // library marker zwaveTools.zwaveDeviceDatabase, line 339
				], // library marker zwaveTools.zwaveDeviceDatabase, line 340
		classVersions:[99:1, 34:1, 78:1, 89:1, 152:1, 0:1, 122:1, 133:2, 112:1, 134:2, 113:8, 114:1, 115:1, 138:1, 90:1, 128:1, 94:1, 32:1, 98:1],  // library marker zwaveTools.zwaveDeviceDatabase, line 341
		endpoints:[	0:[	notificationsSupported:[6:[1, 2, 5, 6, 9, 11], 7:[2]], // library marker zwaveTools.zwaveDeviceDatabase, line 342
						children:[[childName:"Schlage BE469ZP Lock", namespace:"jvm", type:"Generic Component Schlage BE469ZP Lock"]],  // library marker zwaveTools.zwaveDeviceDatabase, line 343
						classes:[0, 32, 34, 78, 89, 90, 94, 98, 99, 112, 113, 114, 115, 122, 128, 133, 134, 138, 152] // library marker zwaveTools.zwaveDeviceDatabase, line 344
						] // library marker zwaveTools.zwaveDeviceDatabase, line 345
					], // library marker zwaveTools.zwaveDeviceDatabase, line 346
		deviceInputs: [ // library marker zwaveTools.zwaveDeviceDatabase, line 347
			3:[size:1, name:"3", description:"Keypad beeper to be turned ON or OFF" , options:[0:"Beeper Disabled", 255:"Beeper Enabled"], title:"(3) Beeper", type:"enum"],  // library marker zwaveTools.zwaveDeviceDatabase, line 348
			4:[size:1, name:"4", title:"(4) Vacation Mode", options:[0:"Disable Vacation Mode", 255:"Enable Vacation Mode"], type:"enum"], // library marker zwaveTools.zwaveDeviceDatabase, line 349
			5:[size:1, name:"5", description:"Controls button push for throwing the deadbolt." , options:[0:"Disable Lock & Leave", 255:"Enable Lock & Leave"], title:"(5) Lock and Leave Mode", type:"enum"],  // library marker zwaveTools.zwaveDeviceDatabase, line 350
			7:[size:1, name:"7", options:[0:"Alarm Off", 1:"Alert", 2:"Tamper", 3:"Forced Entry"], description:"Lock Specific Alarm Mode", title:"(7) Alarm Mode", type:"enum"],  // library marker zwaveTools.zwaveDeviceDatabase, line 351
			8:[size:1, name:"8", options:[1:"Most Sensitive", 2:"More Sensitive", 3:"Medium Sensitivity", 4:"Less Sensitive", 5:"Least Sensitive"], description:"Lock Specific Alarm Alert Sensitivity", title:"(8) Alarm Alert Sensitivity", type:"enum"],  // library marker zwaveTools.zwaveDeviceDatabase, line 352
			9:[size:1, name:"9", options:[1:"Most Sensitive", 2:"More Sensitive", 3:"Medium Sensitivity", 4:"Less Sensitive", 5:"Least Sensitive"], description:"Lock Specific Alarm Tamper Sensitivity", title:"(9) Alarm Tamper Sensitivity", type:"enum"],  // library marker zwaveTools.zwaveDeviceDatabase, line 353
			10:[size:1, name:"10", options:[1:"Most Sensitive", 2:"More Sensitive", 3:"Medium Sensitivity", 4:"Less Sensitive", 5:"Least Sensitive"], description:"Lock Specific Alarm Kick Sensitivity", title:"(10) Alarm Kick Sensitivity", type:"enum"]],  // library marker zwaveTools.zwaveDeviceDatabase, line 354

			11:[size:1, name:"11", description:"Lock Specific Alarm Disable Local Controls", options:[0:"Disable Local Control", 255:"Enable Local Control"], title:"(11) Alarm Disable Local Controls", type:"enum"],  // library marker zwaveTools.zwaveDeviceDatabase, line 356

			15:[size:1, name:"15", description:"Automatically throws the deadbolt 30 after seconds", options:[0:"Disable Auto Lock", 255:"Enable Auto Lock"], title:"(15) Auto Lock", type:"enum"],  // library marker zwaveTools.zwaveDeviceDatabase, line 358
			16:[size:1, name:"16", description:"Required length of all User Codes", options:[4:"4", 5:"5", 6:"6", 7:"7", 8:"8"], title:"(16) User Code PIN Length", type:"enum"] // library marker zwaveTools.zwaveDeviceDatabase, line 359
	],  // library marker zwaveTools.zwaveDeviceDatabase, line 360
] // library marker zwaveTools.zwaveDeviceDatabase, line 361
...
List<Integer> getNotificationTypesList(def cmd) { // library marker zwaveTools.notificationTools, line 43
	...
	return notificationTypes // library marker zwaveTools.notificationTools, line 68
} // library marker zwaveTools.notificationTools, line 69

void zwaveEvent(hubitat.zwave.commands.notificationv8.NotificationSupportedReport report, Integer ep = null ) // library marker zwaveTools.notificationTools, line 71
{ // library marker zwaveTools.notificationTools, line 72
	getNotificationTypesList(report).each{it ->  // library marker zwaveTools.notificationTools, line 73
			basicZwaveSend(zwave.notificationV8.eventSupportedGet(notificationType:(Integer) it), ep)} // library marker zwaveTools.notificationTools, line 74
} // library marker zwaveTools.notificationTools, line 75

void zwaveEvent(hubitat.zwave.commands.notificationv8.EventSupportedReport cmd, Integer ep = null ) // library marker zwaveTools.notificationTools, line 77
{ // library marker zwaveTools.notificationTools, line 78
	// Build a map of the notifications supported by a device endpoint and store it in the endpoint data // library marker zwaveTools.notificationTools, line 79
	List supportedEventsByType = cmd.supportedEvents.findAll{k, v -> ((v as Boolean) == true) }.collect{key, value -> (Integer) key  } // library marker zwaveTools.notificationTools, line 80
	getEndpointNotificationsSupported(ep).put( (Integer) cmd.notificationType , supportedEventsByType) // library marker zwaveTools.notificationTools, line 81
} // library marker zwaveTools.notificationTools, line 82

Map getFormattedZWaveNotificationEvent(def cmd) // library marker zwaveTools.notificationTools, line 84
{ // library marker zwaveTools.notificationTools, line 85
	Date currentDate = new Date() // library marker zwaveTools.notificationTools, line 86
	Map notificationEvent = // library marker zwaveTools.notificationTools, line 87
		[ 	0x01:[ // Smoke // library marker zwaveTools.notificationTools, line 88
				0:[	 // library marker zwaveTools.notificationTools, line 89
						1:[name:"smoke" , value:"clear", descriptionText:"Smoke detected (location provided) status Idle."], // library marker zwaveTools.notificationTools, line 90
						2:[name:"smoke" , value:"clear", descriptionText:"Smoke detector status Idle."], // library marker zwaveTools.notificationTools, line 91
						4:[name:"consumableStatus " , value:"good", descriptionText:"Replacement (cleared)."],				 // library marker zwaveTools.notificationTools, line 92
						5:[name:"consumableStatus " , value:"good", descriptionText:"Replacement (cleared)."],				 // library marker zwaveTools.notificationTools, line 93
						7:[name:"consumableStatus" , value:"good", descriptionText:"Periodic Maintenance Not Due"],				 // library marker zwaveTools.notificationTools, line 94
						8:[name:"consumableStatus" , value:"good", descriptionText:"No Dust in device - clear."], // library marker zwaveTools.notificationTools, line 95
					],  // library marker zwaveTools.notificationTools, line 96
				1:[name:"smoke" , value:"detected", descriptionText:"Smoke detected (location provided)."],  // library marker zwaveTools.notificationTools, line 97
				2:[name:"smoke" , value:"detected", descriptionText:"Smoke detected."], // library marker zwaveTools.notificationTools, line 98
				4:[name:"consumableStatus " , value:"replace", descriptionText:"Replacement required."],				 // library marker zwaveTools.notificationTools, line 99
				5:[name:"consumableStatus " , value:"replace", descriptionText:"Replacement required (End-of-Life)."],				 // library marker zwaveTools.notificationTools, line 100
				7:[name:"consumableStatus" , value:"maintenance_required", descriptionText:"Maintenance required, periodic inspection."],				 // library marker zwaveTools.notificationTools, line 101
				8:[name:"consumableStatus" , value:"maintenance_required", descriptionText:"Maintenance required, dust in device."], // library marker zwaveTools.notificationTools, line 102
				], // library marker zwaveTools.notificationTools, line 103
			0x02:[ // CO // library marker zwaveTools.notificationTools, line 104
				0:[ // library marker zwaveTools.notificationTools, line 105
						1:[name:"carbonMonoxide" , value:"clear", descriptionText:"Carbon Monoxide status."], // library marker zwaveTools.notificationTools, line 106
						2:[name:"carbonMonoxide" , value:"clear", descriptionText:"Carbon Monoxide status."],	 // library marker zwaveTools.notificationTools, line 107
						4:[name:"consumableStatus " , value:"good", descriptionText:"Replacement (cleared)."],				 // library marker zwaveTools.notificationTools, line 108
						5:[name:"consumableStatus " , value:"good", descriptionText:"Replacement (cleared)."],				 // library marker zwaveTools.notificationTools, line 109
						7:[name:"consumableStatus" , value:"good", descriptionText:"Maintenance required cleared, periodic inspection."],				 // library marker zwaveTools.notificationTools, line 110
					],  // library marker zwaveTools.notificationTools, line 111
				1:[name:"carbonMonoxide" , value:"detected", descriptionText:"Carbon Monoxide detected (location provided)."],  // library marker zwaveTools.notificationTools, line 112
				2:[name:"carbonMonoxide" , value:"detected", descriptionText:"Carbon Monoxide detected."], // library marker zwaveTools.notificationTools, line 113
				4:[name:"consumableStatus " , value:"replace", descriptionText:"Replacement required (End-of-Life)."],				 // library marker zwaveTools.notificationTools, line 114
				5:[name:"consumableStatus" , value:"maintenance_required", descriptionText:"Maintenance required, periodic inspection."],				 // library marker zwaveTools.notificationTools, line 115
				7:[name:"consumableStatus" , value:"maintenance_required", descriptionText:"Maintenance required, dust in device."], // library marker zwaveTools.notificationTools, line 116
				], // library marker zwaveTools.notificationTools, line 117
			0x03:[ // CO2 // library marker zwaveTools.notificationTools, line 118
				0:[ // library marker zwaveTools.notificationTools, line 119
						1:[name:"carbonDioxideDetected" , value:"clear", descriptionText:"Carbon Dioxide status."], // library marker zwaveTools.notificationTools, line 120
						2:[name:"carbonDioxideDetected" , value:"clear", descriptionText:"Carbon Dioxide status."],	 // library marker zwaveTools.notificationTools, line 121
						4:[name:"consumableStatus " , value:"good", descriptionText:"Replacement (cleared)."],				 // library marker zwaveTools.notificationTools, line 122
						5:[name:"consumableStatus " , value:"good", descriptionText:"Replacement (cleared)."],				 // library marker zwaveTools.notificationTools, line 123
						7:[name:"consumableStatus" , value:"good", descriptionText:"Maintenance (cleared)."],				 // library marker zwaveTools.notificationTools, line 124
					],  // library marker zwaveTools.notificationTools, line 125
				1:[name:"carbonDioxideDetected" , value:"detected", descriptionText:"Carbon Dioxide detected (location provided)."],  // library marker zwaveTools.notificationTools, line 126
				2:[name:"carbonDioxideDetected" , value:"detected", descriptionText:"Carbon Dioxide detected."], // library marker zwaveTools.notificationTools, line 127
				4:[name:"consumableStatus " , value:"replace", descriptionText:"Replacement required (End-of-Life)."],				 // library marker zwaveTools.notificationTools, line 128
				5:[name:"consumableStatus" , value:"maintenance_required", descriptionText:"Maintenance required, periodic inspection."],				 // library marker zwaveTools.notificationTools, line 129
				7:[name:"consumableStatus" , value:"maintenance_required", descriptionText:"Maintenance required, dust in device."], // library marker zwaveTools.notificationTools, line 130
				], // library marker zwaveTools.notificationTools, line 131
			0x04:[ // Heat Alarm - requires custom attribute heatAlarm // library marker zwaveTools.notificationTools, line 132
				0:[ // library marker zwaveTools.notificationTools, line 133
						1:[name:"heatAlarm" , value:"normal", descriptionText:"Heat Alarm Notification, Status Normal."], // library marker zwaveTools.notificationTools, line 134
						2:[name:"heatAlarm" , value:"normal", descriptionText:"Heat Alarm Notification, Status Normal."], // library marker zwaveTools.notificationTools, line 135
						5:[name:"heatAlarm " , value:"normal", descriptionText:"Heat Alarm Notification, Status Normal."], // library marker zwaveTools.notificationTools, line 136
						6:[name:"heatAlarm " , value:"normal", descriptionText:"Heat Alarm Notification, Status Normal."], // library marker zwaveTools.notificationTools, line 137
						8:[name:"consumableStatus " , value:"good", descriptionText:"Replacement required (End-of-Life)."],				 // library marker zwaveTools.notificationTools, line 138
						10:[name:"consumableStatus" , value:"good", descriptionText:"Maintenance (cleared)"],				 // library marker zwaveTools.notificationTools, line 139
						11:[name:"consumableStatus" , value:"good", descriptionText:"Maintenance (cleared)"], // library marker zwaveTools.notificationTools, line 140
						12:[name:"heatAlarm " , value:"normal", descriptionText:"Heat Alarm Notification, Status Normal."], // library marker zwaveTools.notificationTools, line 141
						13:[name:"heatAlarm " , value:"normal", descriptionText:"Heat Alarm Notification, Status Normal."],	 // library marker zwaveTools.notificationTools, line 142
				],  // library marker zwaveTools.notificationTools, line 143
				1:[name:"heatAlarm" , value:"overheat", descriptionText:"Overheat detected, Location Provided."], // library marker zwaveTools.notificationTools, line 144
				2:[name:"heatAlarm" , value:"overheat", descriptionText:"Overheat detected, Unknown Location."], // library marker zwaveTools.notificationTools, line 145
				3:[name:"heatAlarm " , value:"rapidRise", descriptionText:"Rapid Temperature Rise detected, Location Provided."], // library marker zwaveTools.notificationTools, line 146
				4:[name:"heatAlarm " , value:"rapidRise", descriptionText:"Rapid Temperature Rise detected, Unknown Location."],				 // library marker zwaveTools.notificationTools, line 147
				5:[name:"heatAlarm " , value:"underheat", descriptionText:"Underheat detected, Location Provided."], // library marker zwaveTools.notificationTools, line 148
				6:[name:"heatAlarm " , value:"underheat", descriptionText:"Underheat detected, Unknown Location."], // library marker zwaveTools.notificationTools, line 149
				8:[name:"consumableStatus " , value:"replace", descriptionText:"Replacement required (End-of-Life)."],				 // library marker zwaveTools.notificationTools, line 150
				10:[name:"consumableStatus" , value:"maintenance_required", descriptionText:"Maintenance required, periodic inspection."],				 // library marker zwaveTools.notificationTools, line 151
				11:[name:"consumableStatus" , value:"maintenance_required", descriptionText:"Maintenance required, dust in device."], // library marker zwaveTools.notificationTools, line 152
				12:[name:"heatAlarm " , value:"rapidFall", descriptionText:"Rapid Temperature Fall detected, Location Provided."], // library marker zwaveTools.notificationTools, line 153
				13:[name:"heatAlarm " , value:"rapidFall", descriptionText:"Rapid Temperature Fall detected, Unknown Location."],				 // library marker zwaveTools.notificationTools, line 154
				],				 // library marker zwaveTools.notificationTools, line 155
			0x05:[ // Water	 // library marker zwaveTools.notificationTools, line 156
				0:[ // library marker zwaveTools.notificationTools, line 157
						1:[name:"water" , value:"dry", descriptionText:"Water Alarm Notification, Status Dry."], // library marker zwaveTools.notificationTools, line 158
						2:[name:"water" , value:"dry", descriptionText:"Water Alarm Notification, Status Dry."], // library marker zwaveTools.notificationTools, line 159
						5:[name:"filterStatus " , value:"normal", descriptionText:"Water filter good."],				 // library marker zwaveTools.notificationTools, line 160

				],  // library marker zwaveTools.notificationTools, line 162
				1:[name:"water" , value:"wet", descriptionText:"Water leak detected (location provided)."],  // library marker zwaveTools.notificationTools, line 163
				2:[name:"water" , value:"wet", descriptionText:"Water leak detected."], // library marker zwaveTools.notificationTools, line 164
				5:[name:"filterStatus " , value:"replace", descriptionText:"Replace water filter (End-of-Life)."],				 // library marker zwaveTools.notificationTools, line 165

				], // library marker zwaveTools.notificationTools, line 167
			0x06:[ // Access Control (Locks) // library marker zwaveTools.notificationTools, line 168
				0:[],  // library marker zwaveTools.notificationTools, line 169
				1:[name:"lock" , value:"locked", descriptionText:"Manual lock operation"],  // library marker zwaveTools.notificationTools, line 170
				2:[name:"lock" , value:"unlocked", descriptionText:"Manual unlock operation"],  // library marker zwaveTools.notificationTools, line 171
				3:[name:"lock" , value:"locked", descriptionText:"RF lock operation"],  // library marker zwaveTools.notificationTools, line 172
				4:[name:"lock" , value:"unlocked", descriptionText:"RF unlock operation"],  // library marker zwaveTools.notificationTools, line 173
				5:[name:"lock" , value:"locked", descriptionText:"Keypad lock operation"],  // library marker zwaveTools.notificationTools, line 174
				6:[name:"lock" , value:"unlocked", descriptionText:"Keypad unlock operation"],  // library marker zwaveTools.notificationTools, line 175
...
void off(Map inputs = [:]) { // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 139
	...
	Integer ep = getChildEndpointNumber(params.cd) // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 141
	sendEventToEndpoints(event:[name: "switch", value: "off", descriptionText: "Device turned off", type: "digital"], ep:ep) // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 142
	sendZwaveValue(value: 0, duration: params.duration, ep: ep) // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 143
} // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 144

void componentSetLevel(com.hubitat.app.DeviceWrapper cd, level, transitionTime = null) { // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 146
	if (cd.hasCapability("FanControl") ) { // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 147
			setSpeed(cd:cd, level:level, speed:levelToSpeed(level as Integer)) // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 148
		} else {  // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 149
			setLevel(level:level, duration:transitionTime, cd:cd)  // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 150
		} // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 151
} // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 152

void setLevel(level, duration = null ) { // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 154
	setLevel(level:level, duration:duration) // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 155
} // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 156

void setLevel(Map params = [cd: null , level: null , duration: null ]) // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 158
{ // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 159
	if ( (params.level as Integer) <= 0) { // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 160
		off(cd:params.cd, duration:params.duration) // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 161
	} else { // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 162
		on(cd:params.cd, level:params.level, duration:params.duration) // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 163
	} // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 164
} // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 165


void componentStartLevelChange(com.hubitat.app.DeviceWrapper cd, direction) { startLevelChange(direction, cd) } // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 168
void startLevelChange(direction, cd = null ){ // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 169
	com.hubitat.app.DeviceWrapper targetDevice = (cd ? cd : device) // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 170
	Integer ep = cd ? (cd.deviceNetworkId.split("-ep")[-1] as Integer) : null // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 171

    Integer upDown = (direction == "down") ? 1 : 0 // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 173

	def sendMe = zwave.switchMultilevelV1.switchMultilevelStartLevelChange(upDown: upDown, ignoreStartLevel: 1, startLevel: 0) // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 175

    advancedZwaveSend(sendMe, ep) // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 177
} // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 178



void componentStopLevelChange(com.hubitat.app.DeviceWrapper cd) { stopLevelChange(cd) } // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 182
void stopLevelChange(cd = null ){ // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 183
	com.hubitat.app.DeviceWrapper targetDevice = (cd ? cd : device) // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 184
	Integer ep = cd ? (cd.deviceNetworkId.split("-ep")[-1] as Integer) : null // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 185

	advancedZwaveSend(zwave.switchMultilevelV4.switchMultilevelStopLevelChange(), ep) // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 187
	advancedZwaveSend(zwave.basicV1.basicGet(), ep) // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 188
...
//////                Handle Fans                /////// // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 192
//////////////////////////////////////////////////////// // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 193

String levelToSpeed(Integer level) // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 195
{ // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 196
// 	Map speeds = [(0..0):"off", (1..20):"low", (21..40):"medium-low", (41-60):"medium", (61..80):"medium-high", (81..100):"high"] // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 197
//	return (speeds.find{ key, value -> key.contains(level) }).value // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 198
	switch (level) // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 199
	{ // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 200
	case 0 : 		return "off" ; break // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 201
	case 1..20: 	return "low" ; break // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 202
	case 21..40: 	return "medium-low" ; break // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 203
	case 41..60: 	return "medium" ; break // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 204
	case 61..80: 	return "medium-high" ; break // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 205
	case 81..100: 	return "high" ; break // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 206
	default : return null // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 207
	} // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 208
} // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 209

Integer speedToLevel(String speed) { // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 211
	return ["off": 0, "low":20, "medium-low":40, "medium":60, "medium-high":80, "high":100].get(speed) // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 212
} // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 213

void componentSetSpeed(com.hubitat.app.DeviceWrapper cd, speed) { setSpeed(speed:speed, cd:cd) } // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 215
void setSpeed(speed, com.hubitat.app.DeviceWrapper cd = null ) { setSpeed(speed:speed, cd:cd) } // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 216
void setSpeed(Map params = [speed: null , level: null , cd: null ]) // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 217
{ // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 218
	com.hubitat.app.DeviceWrapper originatingDevice = params.cd ?: device // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 219
	Integer ep = params.cd ? (originatingDevice.deviceNetworkId.split("-ep")[-1] as Integer) : 0 // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 220

	List<com.hubitat.app.DeviceWrapper> targetDevices = getChildDeviceListByEndpoint(ep) // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 222

	if (params.speed.is( null ) ) { // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 224
		log.error "Device ${originatingDevice.displayName}: setSpeed command received without a valid speed setting. Speed setting was ${params.speed}. Returning without doing anything!" // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 225
		return // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 226
	} // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 227

    if (logEnable) log.info "Device ${device.displayName}: received setSpeed(${params.speed}) request from child ${originatingDevice.displayName}" // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 229

	String currentOnState = originatingDevice.currentValue("switch") // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 231
	Integer currentLevel = originatingDevice.currentValue("level") // Null if attribute isn't supported. // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 232
	Integer targetLevel // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 233

	if (params.speed == "on") // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 235
	{ // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 236
		currentLevel = currentLevel ?: 100 // If it was a a level of 0, turn to 100%. Level should never be 0 -- except it might be 0 or null on first startup! // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 237

		targetDevices.each{ // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 239
			it.sendEvent(name: "switch", value: "on", descriptionText: "Fan turned on", type: "digital") // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 240
			it.sendEvent(name: "level", value: currentLevel, descriptionText: "Fan level set", unit:"%", type: "digital") // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 241
			it.sendEvent(name: "speed", value: levelToSpeed(currentLevel), descriptionText: "Fan speed set", type: "digital") // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 242
		} // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 243
		sendZwaveValue(value: currentLevel, duration: 0, ep: ep) // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 244

	} else if (params.speed == "off") // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 246
	{  // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 247
		targetDevices.each{ // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 248
			it.sendEvent(name: "switch", value: "off", descriptionText: "Fan switched off", type: "digital") // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 249
			it.sendEvent(name: "speed", value: "off", descriptionText: "Fan speed set", type: "digital") // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 250
		}			 // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 251

		sendZwaveValue(value: 0, duration: 0, ep: ep) // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 253

	} else { // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 255
		targetLevel = (params.level as Integer) ?: speedToLevel(params.speed) ?: currentLevel // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 256
		targetDevices.each{ // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 257
			it.sendEvent(name: "switch", value: "on", descriptionText: "Fan turned on", type: "digital") // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 258
			it.sendEvent(name: "speed", value: params.speed, descriptionText: "Fan speed set", type: "digital") // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 259
			it.sendEvent(name: "level", value: targetLevel, descriptionText: "Fan level set", unit:"%", type: "digital") // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 260
		} // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 261
		sendZwaveValue(value: targetLevel, duration: 0, ep: ep) // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 262
...
Integer getParameterSize(parameterNumber) { // library marker zwaveTools.parameterGetSendTools, line 55
	...
	log.debug "Parameter size for ${parameterNumber} is ${rValue}" // library marker zwaveTools.parameterGetSendTools, line 57
	return rValue // library marker zwaveTools.parameterGetSendTools, line 58
} // library marker zwaveTools.parameterGetSendTools, line 59

List<Integer> getListOfParameters(){ // library marker zwaveTools.parameterGetSendTools, line 61
	allParameterCharacteristics.collect{k, v -> (int) k} // library marker zwaveTools.parameterGetSendTools, line 62
} // library marker zwaveTools.parameterGetSendTools, line 63

Map getAllParameterValues(){ // library marker zwaveTools.parameterGetSendTools, line 65
	getListedParameterValues(listOfParameters) // library marker zwaveTools.parameterGetSendTools, line 66
} // library marker zwaveTools.parameterGetSendTools, line 67


Boolean parameterRangeValid( inputs = [parameterNumber: null , value: null ]) { // library marker zwaveTools.parameterGetSendTools, line 70
	Map thisParameter = parameterCharacteristics((int) inputs.parameterNumber) // library marker zwaveTools.parameterGetSendTools, line 71

	if (thisParameter.maxValue && ((int) thisParameter.maxValue < (int) inputs.value)) { // library marker zwaveTools.parameterGetSendTools, line 73
		log.warn "For parameter ${inputs.parameterNumber}, value ${inputs.value} exceeds maximum permitted value of ${thisParameter.maxValue}" // library marker zwaveTools.parameterGetSendTools, line 74
		return false // library marker zwaveTools.parameterGetSendTools, line 75
		} // library marker zwaveTools.parameterGetSendTools, line 76
	if (thisParameter.minValue && ((int) thisParameter.minValue > (int) inputs.value)) { // library marker zwaveTools.parameterGetSendTools, line 77
		log.warn "For parameter ${inputs.parameterNumber}, value ${inputs.value} is below minimum permitted value of ${thisParameter.minValue}" // library marker zwaveTools.parameterGetSendTools, line 78
		return false // library marker zwaveTools.parameterGetSendTools, line 79
		} // library marker zwaveTools.parameterGetSendTools, line 80

	return true // library marker zwaveTools.parameterGetSendTools, line 82
} // library marker zwaveTools.parameterGetSendTools, line 83

Map getListedParameterValues(List<Integer> parameterList, Boolean useCache = true ) { // library marker zwaveTools.parameterGetSendTools, line 85
	parameterList?.collectEntries{ it -> // library marker zwaveTools.parameterGetSendTools, line 86
			Integer newValue = getParameterValue(parameterNumber:((int) it), useCache:(useCache), waitTime:2) // library marker zwaveTools.parameterGetSendTools, line 87
			[(it):(newValue)] // library marker zwaveTools.parameterGetSendTools, line 88
		} // library marker zwaveTools.parameterGetSendTools, line 89
} // library marker zwaveTools.parameterGetSendTools, line 90

void zwaveEvent(hubitat.zwave.commands.configurationv2.ConfigurationReport  cmd) // library marker zwaveTools.parameterGetSendTools, line 92
{  // library marker zwaveTools.parameterGetSendTools, line 93
	Integer newValue = (cmd.size == 1) ? cmd.configurationValue[0] : cmd.scaledConfigurationValue			 // library marker zwaveTools.parameterGetSendTools, line 94
	if (newValue < 0) log.warn "Device ${device.displayName}: Negative configuration value reported for configuration parameter ${cmd.parameterNumber}." // library marker zwaveTools.parameterGetSendTools, line 95

	parameterStorageMap.put((cmd.parameterNumber as Integer), newValue ) // library marker zwaveTools.parameterGetSendTools, line 97

	myReportQueue(cmd.CMD).offer( cmd ) // library marker zwaveTools.parameterGetSendTools, line 99
	(childDevices + this).each{ if (it.handleParameterReport) it.handleParameterReport(cmd)} // library marker zwaveTools.parameterGetSendTools, line 100
} // library marker zwaveTools.parameterGetSendTools, line 101

void getParameter(number){ // library marker zwaveTools.parameterGetSendTools, line 103
	advancedZwaveSend( zwave.configurationV1.configurationGet(parameterNumber: (int) number)) // library marker zwaveTools.parameterGetSendTools, line 104

} // library marker zwaveTools.parameterGetSendTools, line 106

Integer getParameterValue(params = [:]) { // library marker zwaveTools.parameterGetSendTools, line 108

	Map inputs = [parameterNumber: null , useCache: true , waitTime: 1] << params // library marker zwaveTools.parameterGetSendTools, line 110
	log.debug "getting a parameter value using inputs ${inputs}" // library marker zwaveTools.parameterGetSendTools, line 111
	if (inputs.parameterNumber.is( null ))  { // library marker zwaveTools.parameterGetSendTools, line 112
			log.error "In function getParameterValue, no parameter number was specified. Returning null" // library marker zwaveTools.parameterGetSendTools, line 113
			return null // library marker zwaveTools.parameterGetSendTools, line 114
		} // library marker zwaveTools.parameterGetSendTools, line 115
	Integer rValue = null // library marker zwaveTools.parameterGetSendTools, line 116
	if (inputs.useCache) rValue = getParameterStorageMap().get((int) inputs.parameterNumber) // library marker zwaveTools.parameterGetSendTools, line 117
...
def setParameter(parameterNumber, value) {setParameter(parameterNumber:parameterNumber, value:value)} // library marker zwaveTools.parameterGetSendTools, line 130
def setParameter( Map params = [:]){ // library marker zwaveTools.parameterGetSendTools, line 131
	...
	log.debug "setting a parameter value using inputs ${inputs}" // library marker zwaveTools.parameterGetSendTools, line 141

	advancedZwaveSend(zwave.configurationV1.configurationSet(scaledConfigurationValue: (inputs.value as BigInteger), parameterNumber: (inputs.parameterNumber), size: (getParameterSize(inputs.parameterNumber)) )) // library marker zwaveTools.parameterGetSendTools, line 143

	advancedZwaveSend( zwave.configurationV1.configurationGet(parameterNumber: (inputs.parameterNumber))) // library marker zwaveTools.parameterGetSendTools, line 145

	hubitat.zwave.Command  report = myReportQueue("7006").poll(inputs.waitTime, TimeUnit.SECONDS)  // library marker zwaveTools.parameterGetSendTools, line 147
	return report // library marker zwaveTools.parameterGetSendTools, line 148
} // library marker zwaveTools.parameterGetSendTools, line 149



void clearSettings(){ // library marker zwaveTools.parameterGetSendTools, line 153
	List<String> preserve = ["txtEnable", "logEnable"] // If particular settings are to be preserved, list them here // library marker zwaveTools.parameterGetSendTools, line 154

    def keys = new HashSet(settings.keySet()) // library marker zwaveTools.parameterGetSendTools, line 156
    keys.each{ key -> device.removeSetting(key) } // library marker zwaveTools.parameterGetSendTools, line 157

	device.removeSetting("") // library marker zwaveTools.parameterGetSendTools, line 159
	log.info "Device ${device.displayName}: Remaining preference settings after cleanup are: " + settings // library marker zwaveTools.parameterGetSendTools, line 160
} // library marker zwaveTools.parameterGetSendTools, line 161
