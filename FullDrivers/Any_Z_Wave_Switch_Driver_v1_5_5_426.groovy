...
metadata {
	definition (name: "Any Z-Wave Switch Driver v1.5.5",namespace: "jvm", author: "jvm") {
...
void	refreshLock(Integer ep = null ) {
...
String secure(hubitat.zwave.Command cmd, Integer ep = null ){  // library marker zwaveTools.sendReceiveTools, line 48
	if (ep) { // library marker zwaveTools.sendReceiveTools, line 49
		return zwaveSecureEncap(zwave.multiChannelV4.multiChannelCmdEncap(sourceEndPoint: 0, bitAddress: 0, res01:0, destinationEndPoint: ep).encapsulate(cmd)) // library marker zwaveTools.sendReceiveTools, line 50
	} else { // library marker zwaveTools.sendReceiveTools, line 51
		return zwaveSecureEncap(cmd)  // library marker zwaveTools.sendReceiveTools, line 52
	} // library marker zwaveTools.sendReceiveTools, line 53
} // library marker zwaveTools.sendReceiveTools, line 54

// a simple unsupervised send with endpoint support // library marker zwaveTools.sendReceiveTools, line 56
void basicZwaveSend(hubitat.zwave.Command cmd, Integer ep = null ) {  // library marker zwaveTools.sendReceiveTools, line 57
	sendHubCommand(new hubitat.device.HubAction( secure(cmd, ep), hubitat.device.Protocol.ZWAVE))  // library marker zwaveTools.sendReceiveTools, line 58
} // library marker zwaveTools.sendReceiveTools, line 59

////    Security Encapsulation   //// // library marker zwaveTools.sendReceiveTools, line 61
void zwaveEvent(hubitat.zwave.commands.securityv1.SecurityMessageEncapsulation cmd) { // library marker zwaveTools.sendReceiveTools, line 62
	hubitat.zwave.Command encapsulatedCommand = cmd.encapsulatedCommand( (userParseMap ?: defaultParseMap) ) // library marker zwaveTools.sendReceiveTools, line 63
    if (encapsulatedCommand) { zwaveEvent(encapsulatedCommand) } // library marker zwaveTools.sendReceiveTools, line 64
} // library marker zwaveTools.sendReceiveTools, line 65

////    Multi-Channel Encapsulation   //// // library marker zwaveTools.sendReceiveTools, line 67
void zwaveEvent(hubitat.zwave.commands.multichannelv4.MultiChannelCmdEncap cmd) { // library marker zwaveTools.sendReceiveTools, line 68
    hubitat.zwave.Command  encapsulatedCommand = cmd.encapsulatedCommand((userParseMap ?: defaultParseMap)) // library marker zwaveTools.sendReceiveTools, line 69
    if (encapsulatedCommand) { zwaveEvent(encapsulatedCommand, cmd.sourceEndPoint) } // library marker zwaveTools.sendReceiveTools, line 70
} // library marker zwaveTools.sendReceiveTools, line 71


//// Catch Event Not Otherwise Handled! ///// // library marker zwaveTools.sendReceiveTools, line 74
void zwaveEvent(hubitat.zwave.Command cmd, Integer ep = null ) { // library marker zwaveTools.sendReceiveTools, line 75
    log.warn "Device ${device.displayName}: Received Z-Wave Message ${cmd} that is not handled by this driver. Endpoint: ${ep ?: 0}. Message class: ${cmd.class}." // library marker zwaveTools.sendReceiveTools, line 76
} // library marker zwaveTools.sendReceiveTools, line 77

////////////////////////////////////////////////////////////////////// // library marker zwaveTools.sendReceiveTools, line 79
//////        Handle Supervision request and reports           /////// // library marker zwaveTools.sendReceiveTools, line 80
//////////////////////////////////////////////////////////////////////  // library marker zwaveTools.sendReceiveTools, line 81

// @Field static results in variable being shared among all devices that use the same driver, so I use a concurrentHashMap keyed by a device's deviceNetworkId to get a unqiue value for a particular device // library marker zwaveTools.sendReceiveTools, line 83
// supervisionSessionIDs stores the last used sessionID value (0..63) for a device. It must be incremented mod 64 on each send // library marker zwaveTools.sendReceiveTools, line 84
// supervisionSentCommands stores the last command sent // library marker zwaveTools.sendReceiveTools, line 85
// Each is initialized for 64 devices, but can automatically grow // library marker zwaveTools.sendReceiveTools, line 86
@Field static ConcurrentHashMap<String, Integer> supervisionSessionIDs = new ConcurrentHashMap<String, Integer>(64, 0.75, 1) // library marker zwaveTools.sendReceiveTools, line 87
@Field static ConcurrentHashMap<String, ConcurrentHashMap> supervisionSentCommands = new ConcurrentHashMap<String, ConcurrentHashMap<Integer, String>>(64, 0.75, 1) // library marker zwaveTools.sendReceiveTools, line 88

Integer getNewSessionId() { // library marker zwaveTools.sendReceiveTools, line 90
		// Get the next session ID mod 64, but if there is no stored session ID, initialize it with a random value. // library marker zwaveTools.sendReceiveTools, line 91
		Integer lastSessionID = supervisionSessionIDs.get(device.getDeviceNetworkId() ,((Integer)(Math.random() * 64) % 64)  ) // library marker zwaveTools.sendReceiveTools, line 92
		Integer nextSessionID = (lastSessionID + 1) % 64 // increment and then mod with 64, and then store it back in the Hash table. // library marker zwaveTools.sendReceiveTools, line 93
		supervisionSessionIDs.replace(device.getDeviceNetworkId(), nextSessionID) // library marker zwaveTools.sendReceiveTools, line 94
		return nextSessionID // library marker zwaveTools.sendReceiveTools, line 95
}  // library marker zwaveTools.sendReceiveTools, line 96

Boolean getNeverSupervise() // library marker zwaveTools.sendReceiveTools, line 98
{ // library marker zwaveTools.sendReceiveTools, line 99
	Integer mfr = 			getDataValue("manufacturer")?.toInteger() // library marker zwaveTools.sendReceiveTools, line 100
	Integer deviceId = 		getDataValue("deviceId")?.toInteger() // library marker zwaveTools.sendReceiveTools, line 101
	Integer deviceType =	getDataValue("deviceType")?.toInteger() // library marker zwaveTools.sendReceiveTools, line 102
	List<Map> supervisionBroken = [ // library marker zwaveTools.sendReceiveTools, line 103
			[	manufacturer:798,  	deviceType:14,	deviceId: 1  	], // Inovelli LZW36 firmware 1.36 supervision is broken! // library marker zwaveTools.sendReceiveTools, line 104
			]  // library marker zwaveTools.sendReceiveTools, line 105
	if (userSupervisionBrokenMap) {supervisionBroken += userSupervisionBrokenMap} // library marker zwaveTools.sendReceiveTools, line 106

	Map thisDevice =	supervisionBroken.find{ ((it.manufacturer == mfr ) && (it.deviceId == deviceId ) && (it.deviceType == deviceType)) } // library marker zwaveTools.sendReceiveTools, line 108

	if (thisDevice && logEnable) log.warn "Device ${device.displayName}: This device is on the Never Supervise list. Check manufacturer for a firmware update. Not supervising." // library marker zwaveTools.sendReceiveTools, line 110
	return ( thisDevice ? true : false ) // library marker zwaveTools.sendReceiveTools, line 111
} // library marker zwaveTools.sendReceiveTools, line 112

Boolean ignoreSupervisionNoSupportCode() // library marker zwaveTools.sendReceiveTools, line 114
{ // library marker zwaveTools.sendReceiveTools, line 115
	// Some devices implement the Supervision command class incorrectly and return a "No Support" code even when they work. // library marker zwaveTools.sendReceiveTools, line 116
	// This function is to ignore the No Support code from those devices. // library marker zwaveTools.sendReceiveTools, line 117
	Integer mfr = 			getDataValue("manufacturer")?.toInteger() // library marker zwaveTools.sendReceiveTools, line 118
	Integer deviceId = 		getDataValue("deviceId")?.toInteger() // library marker zwaveTools.sendReceiveTools, line 119
	Integer deviceType =	getDataValue("deviceType")?.toInteger() // library marker zwaveTools.sendReceiveTools, line 120
	List<Map> poorSupervisionSupport = [ // library marker zwaveTools.sendReceiveTools, line 121
			[	manufacturer:12,  	deviceType:17479,	deviceId: 12340  	], // HomeSeer WD100 S2 is buggy! // library marker zwaveTools.sendReceiveTools, line 122
			[	manufacturer:12,  	deviceType:17479,	deviceId: 12342  	], // HomeSeer WD200 is buggy! // library marker zwaveTools.sendReceiveTools, line 123
			] // library marker zwaveTools.sendReceiveTools, line 124

	if (userPoorSupervisionSupportMap) {poorSupervisionSupport += userPoorSupervisionSupportMap} // library marker zwaveTools.sendReceiveTools, line 126

    Map thisDevice =	poorSupervisionSupport.find{((it.manufacturer == mfr ) && (it.deviceId == deviceId ) && (it.deviceType == deviceType)) } // library marker zwaveTools.sendReceiveTools, line 128
	if (thisDevice && logEnable) log.warn "Device ${device.displayName}: This device is on the Poor Supervise Support list. Check manufacturer for a firmware update. Ignoring 'No Support' return codes." // library marker zwaveTools.sendReceiveTools, line 129

		return ( thisDevice ? true : false )				 // library marker zwaveTools.sendReceiveTools, line 131
} // library marker zwaveTools.sendReceiveTools, line 132

Boolean getSuperviseThis() { // library marker zwaveTools.sendReceiveTools, line 134
		if (neverSupervise) return false // library marker zwaveTools.sendReceiveTools, line 135
		return (getDataValue("S2")?.toInteger() != null ) // library marker zwaveTools.sendReceiveTools, line 136
} // library marker zwaveTools.sendReceiveTools, line 137

void advancedZwaveSend(hubitat.zwave.Command cmd, Integer ep = null ) {  // library marker zwaveTools.sendReceiveTools, line 139
	List<String> superviseThese = [ "2501", // Switch Binary // library marker zwaveTools.sendReceiveTools, line 140
									"2601", "2604", "2605", //  Switch MultiLevel  // library marker zwaveTools.sendReceiveTools, line 141
									"7601", // Lock V1 // library marker zwaveTools.sendReceiveTools, line 142
									"3305", // Switch Color Set									 // library marker zwaveTools.sendReceiveTools, line 143
									] // library marker zwaveTools.sendReceiveTools, line 144
	if (userDefinedSupervisionList) superviseThese += userDefinedSupervisionList								 // library marker zwaveTools.sendReceiveTools, line 145
	if (superviseThese.contains(cmd.CMD)) { // library marker zwaveTools.sendReceiveTools, line 146
		sendSupervised(cmd, ep) // library marker zwaveTools.sendReceiveTools, line 147
	} else { // library marker zwaveTools.sendReceiveTools, line 148
		sendUnsupervised(cmd, ep) // library marker zwaveTools.sendReceiveTools, line 149
	} // library marker zwaveTools.sendReceiveTools, line 150
} // library marker zwaveTools.sendReceiveTools, line 151


void sendSupervised(hubitat.zwave.Command cmd, Integer ep = null ) {  // library marker zwaveTools.sendReceiveTools, line 154
	if (superviseThis) { // library marker zwaveTools.sendReceiveTools, line 155
		Integer thisSessionId = getNewSessionId() // library marker zwaveTools.sendReceiveTools, line 156
		ConcurrentHashMap commandStorage = supervisionSentCommands.get(device.getDeviceNetworkId() , new ConcurrentHashMap<Integer, hubitat.zwave.Command>(64, 0.75, 1)) // library marker zwaveTools.sendReceiveTools, line 157

		hubitat.zwave.Command  supervisedCommand = zwave.supervisionV1.supervisionGet(sessionID: thisSessionId, statusUpdates: true ).encapsulate(cmd) // library marker zwaveTools.sendReceiveTools, line 159

		commandStorage.put(thisSessionId, [command:cmd, endPoint:ep, attempt:1, sessionId:thisSessionId])  // library marker zwaveTools.sendReceiveTools, line 161

		basicZwaveSend(supervisedCommand, ep)	 // library marker zwaveTools.sendReceiveTools, line 163

		Integer retryTime	=  Math.min( Math.max( (s2RetryPeriod ?: 2000), 500), 5000) // library marker zwaveTools.sendReceiveTools, line 165
		runInMillis( retryTime, supervisionCheck)	 // library marker zwaveTools.sendReceiveTools, line 166

	} else { // library marker zwaveTools.sendReceiveTools, line 168
		basicZwaveSend(cmd, ep) // library marker zwaveTools.sendReceiveTools, line 169
	} // library marker zwaveTools.sendReceiveTools, line 170
} // library marker zwaveTools.sendReceiveTools, line 171

void sendUnsupervised(hubitat.zwave.Command cmd, Integer ep = null ) {  // library marker zwaveTools.sendReceiveTools, line 173
	basicZwaveSend(cmd, ep) // library marker zwaveTools.sendReceiveTools, line 174
} // library marker zwaveTools.sendReceiveTools, line 175

// This handles a supervised message (a "get") received from the Z-Wave device // // library marker zwaveTools.sendReceiveTools, line 177
void zwaveEvent(hubitat.zwave.commands.supervisionv1.SupervisionGet cmd, Integer ep = null ) { // library marker zwaveTools.sendReceiveTools, line 178
    hubitat.zwave.Command encapsulatedCommand = cmd.encapsulatedCommand((userParseMap ?: defaultParseMap)) // library marker zwaveTools.sendReceiveTools, line 179

    if (encapsulatedCommand) { // library marker zwaveTools.sendReceiveTools, line 181
		if ( ep ) { // library marker zwaveTools.sendReceiveTools, line 182
			zwaveEvent(encapsulatedCommand, ep) // library marker zwaveTools.sendReceiveTools, line 183
		} else { // library marker zwaveTools.sendReceiveTools, line 184
			zwaveEvent(encapsulatedCommand) // library marker zwaveTools.sendReceiveTools, line 185
		} // library marker zwaveTools.sendReceiveTools, line 186
    } // library marker zwaveTools.sendReceiveTools, line 187

	basicZwaveSend( new hubitat.zwave.commands.supervisionv1.SupervisionReport(sessionID: cmd.sessionID, reserved: 0, moreStatusUpdates: false, status: 0xFF, duration: 0), ep) // library marker zwaveTools.sendReceiveTools, line 189
} // library marker zwaveTools.sendReceiveTools, line 190

void zwaveEvent(hubitat.zwave.commands.supervisionv1.SupervisionReport cmd, Integer ep = null )  // library marker zwaveTools.sendReceiveTools, line 192
{ // library marker zwaveTools.sendReceiveTools, line 193
	ConcurrentHashMap whatThisDeviceSent = supervisionSentCommands?.get(device.getDeviceNetworkId() ) // library marker zwaveTools.sendReceiveTools, line 194

	String whatWasSent = null // library marker zwaveTools.sendReceiveTools, line 196

	switch ((Integer) cmd.status) // library marker zwaveTools.sendReceiveTools, line 198
	{ // library marker zwaveTools.sendReceiveTools, line 199
		case 0x00: // "No Support"  // library marker zwaveTools.sendReceiveTools, line 200
			whatWasSent = whatThisDeviceSent?.remove((Integer)cmd.sessionID) // library marker zwaveTools.sendReceiveTools, line 201
			if (ignoreSupervisionNoSupportCode()) { // library marker zwaveTools.sendReceiveTools, line 202
				if (logEnable) log.warn "Received a 'No Support' supervision report ${cmd} for command ${whatWasSent}, but this device has known problems with its Supervision implementation so the 'No Support' code was ignored." // library marker zwaveTools.sendReceiveTools, line 203
			} else 	{ // library marker zwaveTools.sendReceiveTools, line 204
				log.warn "Device ${targetDevice.displayName}: Z-Wave Command supervision reported as 'No Support' for command ${whatWasSent}. If you see this warning repeatedly, please report as an issue on https://github.com/jvmahon/HubitatCustom/issues. Please provide the manufacturer, deviceType, and deviceId code for your device as shown on the device's Hubitat device web page." // library marker zwaveTools.sendReceiveTools, line 205
			} // library marker zwaveTools.sendReceiveTools, line 206
			break // library marker zwaveTools.sendReceiveTools, line 207
		case 0x01: // "working" - Remove check if you get back a "working" status since you know device is processing the command. // library marker zwaveTools.sendReceiveTools, line 208
			whatWasSent = whatThisDeviceSent?.remove((Integer)cmd.sessionID) // library marker zwaveTools.sendReceiveTools, line 209
			if (txtEnable) log.info "Device ${targetDevice.displayName}: Still processing command: ${whatWasSent}." // library marker zwaveTools.sendReceiveTools, line 210
			// runInMillis(5, supervisionCheck)	 // library marker zwaveTools.sendReceiveTools, line 211
			break ; // library marker zwaveTools.sendReceiveTools, line 212
		case 0x02: // "Fail" // library marker zwaveTools.sendReceiveTools, line 213
			whatWasSent = whatThisDeviceSent?.remove((Integer) cmd.sessionID) // library marker zwaveTools.sendReceiveTools, line 214
			log.warn "Device ${targetDevice.displayName}: Z-Wave supervised command reported failure. Failed command: ${whatWasSent}." // library marker zwaveTools.sendReceiveTools, line 215
			basicZwaveSend(zwave.basicV1.basicGet(), ep) // library marker zwaveTools.sendReceiveTools, line 216
			break // library marker zwaveTools.sendReceiveTools, line 217
		case 0xFF: // "Success" // library marker zwaveTools.sendReceiveTools, line 218
			whatWasSent = whatThisDeviceSent?.remove((Integer) cmd.sessionID) // library marker zwaveTools.sendReceiveTools, line 219
			if (txtEnable || logEnable) log.info "Device ${targetDevice.displayName}: Device successfully processed supervised command ${whatWasSent}." // library marker zwaveTools.sendReceiveTools, line 220
			break // library marker zwaveTools.sendReceiveTools, line 221
	} // library marker zwaveTools.sendReceiveTools, line 222
	if (whatThisDeviceSent?.size() < 1) unschedule(supervisionCheck) // library marker zwaveTools.sendReceiveTools, line 223
} // library marker zwaveTools.sendReceiveTools, line 224

void supervisionCheck() { // library marker zwaveTools.sendReceiveTools, line 226
    // re-attempt supervison once, else send without supervision // library marker zwaveTools.sendReceiveTools, line 227
	ConcurrentHashMap tryAgain = supervisionSentCommands?.get(device.getDeviceNetworkId()) // library marker zwaveTools.sendReceiveTools, line 228
	tryAgain?.each{ thisSessionId, whatWasSent -> // library marker zwaveTools.sendReceiveTools, line 229

		Integer retries = Math.min( Math.max( (s2MaxRetries ?: 2), 1), 5) // library marker zwaveTools.sendReceiveTools, line 231
		if (whatWasSent.attempt <  retries ) { // library marker zwaveTools.sendReceiveTools, line 232
			whatWasSent.attempt += 1 // library marker zwaveTools.sendReceiveTools, line 233
			hubitat.zwave.Command  supervisedCommand = zwave.supervisionV1.supervisionGet(sessionID: thisSessionId, statusUpdates: true ).encapsulate(whatWasSent.command) // library marker zwaveTools.sendReceiveTools, line 234
			basicZwaveSend(supervisedCommand, whatWasSent.endPoint)	 // library marker zwaveTools.sendReceiveTools, line 235
		} else { // library marker zwaveTools.sendReceiveTools, line 236
			basicZwaveSend(whatWasSent.command, whatWasSent.endPoint) // library marker zwaveTools.sendReceiveTools, line 237
			supervisionSentCommands?.get(device.getDeviceNetworkId()).remove((Integer) thisSessionId)		 // library marker zwaveTools.sendReceiveTools, line 238
...
import java.util.concurrent.*  // library marker zwaveTools.globalDataTools, line 13
import groovy.transform.Field // library marker zwaveTools.globalDataTools, line 14

@Field static ConcurrentHashMap globalDataStorage = new ConcurrentHashMap(64, 0.75, 1) // library marker zwaveTools.globalDataTools, line 16

@Field static Integer dataRecordFormatVersion = 1 // library marker zwaveTools.globalDataTools, line 18

ConcurrentHashMap getDataRecordByProductType() // library marker zwaveTools.globalDataTools, line 20
{ // library marker zwaveTools.globalDataTools, line 21
	String manufacturer = 	hubitat.helper.HexUtils.integerToHexString( device.getDataValue("manufacturer").toInteger(), 2) // library marker zwaveTools.globalDataTools, line 22
	String deviceType = 	hubitat.helper.HexUtils.integerToHexString( device.getDataValue("deviceType").toInteger(), 2) // library marker zwaveTools.globalDataTools, line 23
	String deviceID = 		hubitat.helper.HexUtils.integerToHexString( device.getDataValue("deviceId").toInteger(), 2) // library marker zwaveTools.globalDataTools, line 24
	String productKey = "${manufacturer}:${deviceType}:${deviceID}" // library marker zwaveTools.globalDataTools, line 25
	ConcurrentHashMap dataRecord = globalDataStorage.get(productKey, new ConcurrentHashMap<String,ConcurrentHashMap>(8, 0.75, 1)) // library marker zwaveTools.globalDataTools, line 26
	return dataRecord // library marker zwaveTools.globalDataTools, line 27
} // library marker zwaveTools.globalDataTools, line 28

ConcurrentHashMap getDataRecordByNetworkId() // library marker zwaveTools.globalDataTools, line 30
{ // library marker zwaveTools.globalDataTools, line 31
	return globalDataStorage.get(deviceNetworkId, new ConcurrentHashMap<String,ConcurrentHashMap>()) // library marker zwaveTools.globalDataTools, line 32
} // library marker zwaveTools.globalDataTools, line 33

// Debugging Functions // library marker zwaveTools.globalDataTools, line 35
void showGlobalDataRecordByProductType() { // library marker zwaveTools.globalDataTools, line 36
	// Debugging function - shows the entire concurrent @Field 'global' data record for all devices using a particular driver // library marker zwaveTools.globalDataTools, line 37

	log.debug "Data record in global storage is ${dataRecordByProductType.inspect()}." // library marker zwaveTools.globalDataTools, line 39
} // library marker zwaveTools.globalDataTools, line 40

void showFullGlobalDataRecord() { // library marker zwaveTools.globalDataTools, line 42
	// Debugging function - shows the entire concurrent @Field 'global' data record for all devices using a particular driver // library marker zwaveTools.globalDataTools, line 43
	log.debug "Global Data Record Is ${globalDataStorage.inspect()}." // library marker zwaveTools.globalDataTools, line 44
} // library marker zwaveTools.globalDataTools, line 45
...
// Get List (possibly multiple) child device for a specific endpoint. Child devices can also be of the form '-ep000'  // library marker zwaveTools.endpointTools, line 68
// Child devices associated with the root device end in -ep000 // library marker zwaveTools.endpointTools, line 69
List<com.hubitat.app.DeviceWrapper> getChildDeviceListByEndpoint( Integer ep ) { // library marker zwaveTools.endpointTools, line 70
	childDevices.findAll{ getChildEndpointNumber(it)  == (ep ?: 0) } // library marker zwaveTools.endpointTools, line 71
} // library marker zwaveTools.endpointTools, line 72


void sendEventToEndpoints(Map params = [ event: null , ep: null ,  sendEveryEventType: false , addRootToEndpoint0: true ,  alwaysSend: null , neverSend: null ]) // library marker zwaveTools.endpointTools, line 75
{ // library marker zwaveTools.endpointTools, line 76
	List<String> supportedParams = ["event", "ep", "sendEveryEventType", "addRootToEndpoint0", "alwaysSend", "neverSend"] // library marker zwaveTools.endpointTools, line 77
	if (! (params.every{ k, v ->  supportedParams.contains(k) } ) ) { // library marker zwaveTools.endpointTools, line 78
		log.error "Error calling sendEventToEndpoints. Supported parameters are ${supportedParams}. Function was called with parameters: ${params.keySet()}" // library marker zwaveTools.endpointTools, line 79
		return // library marker zwaveTools.endpointTools, line 80
	} // library marker zwaveTools.endpointTools, line 81

	List<com.hubitat.app.DeviceWrapper> targetDevices = getChildDeviceListByEndpoint((Integer)(params.ep ?: 0)) // library marker zwaveTools.endpointTools, line 83

	// If endpoint is 0 or null and there were no child devices with a 0 endpoint, then return the root device as the child. // library marker zwaveTools.endpointTools, line 85
	// || (params.addRootToEndpoint0 as Boolean)) && ((Integer)(params.ep ?: 0)  < 1)   // library marker zwaveTools.endpointTools, line 86

	if (( (Integer) (params.ep ?:0) ) == 0) // library marker zwaveTools.endpointTools, line 88
		{  // library marker zwaveTools.endpointTools, line 89
			if ( (params.addRootToEndpoint0) ? ((params.addRootToEndpoint0) as Boolean) : true ) // library marker zwaveTools.endpointTools, line 90
			{ // library marker zwaveTools.endpointTools, line 91
				targetDevices += device // library marker zwaveTools.endpointTools, line 92
			} // library marker zwaveTools.endpointTools, line 93
		} // library marker zwaveTools.endpointTools, line 94

	if ( params.event.name == "unhandledZwaveEvent" ) {  // library marker zwaveTools.endpointTools, line 96
		if (sendEventNotHandledError) sendEventNotHandledError(params.event) // If this function is defined, it will receive the event to allow logging. // library marker zwaveTools.endpointTools, line 97
	} else {  // library marker zwaveTools.endpointTools, line 98
		Boolean targetNotified = false // library marker zwaveTools.endpointTools, line 99
		targetDevices.each { // library marker zwaveTools.endpointTools, line 100
			if (params.neverSend?.contains(params.event.name)) return // library marker zwaveTools.endpointTools, line 101

			if (it.hasAttribute(params.event.name) || (params.sendEveryEventType) || params.alwaysSend?.contains(params.event.name) ) {  // library marker zwaveTools.endpointTools, line 103
				it.sendEvent(params.event)  // library marker zwaveTools.endpointTools, line 104
				targetNotified = true // library marker zwaveTools.endpointTools, line 105
			} // library marker zwaveTools.endpointTools, line 106
		} // library marker zwaveTools.endpointTools, line 107
		if (! targetNotified) { // library marker zwaveTools.endpointTools, line 108
				if (sendEventNotHandledError) sendEventNotHandledError(params.event) // library marker zwaveTools.endpointTools, line 109
...
void sendEventToAll(Map params = [ event: null , sendEveryEventType: false , addRootToEndpoint0: true ,  alwaysSend: null , neverSend: null ]) // library marker zwaveTools.endpointTools, line 114
{ // library marker zwaveTools.endpointTools, line 115
	List<String> supportedParams = ["event", "ep", "sendEveryEventType", "addRootToEndpoint0", "alwaysSend", "neverSend"] // library marker zwaveTools.endpointTools, line 116
	if (! (params.every{ k, v ->  supportedParams.contains(k) } ) ) { // library marker zwaveTools.endpointTools, line 117
		log.error "Error calling sendEventToAll. Supported parameters are ${supportedParams}. Function was called with parameters: ${params.keySet()}" // library marker zwaveTools.endpointTools, line 118
		return // library marker zwaveTools.endpointTools, line 119
	} // library marker zwaveTools.endpointTools, line 120

	List<com.hubitat.app.DeviceWrapper> targetDevices = getChildDevices() + device // library marker zwaveTools.endpointTools, line 122

	if ( params.event.name == "unhandledZwaveEvent" ) {  // library marker zwaveTools.endpointTools, line 124
		if (sendEventNotHandledError) sendEventNotHandledError(params.event) // If this function is defined, it will receive the event to allow logging. // library marker zwaveTools.endpointTools, line 125
	} else {  // library marker zwaveTools.endpointTools, line 126
		Boolean targetNotified = false // library marker zwaveTools.endpointTools, line 127
		targetDevices.each { // library marker zwaveTools.endpointTools, line 128
			if (params.neverSend?.contains(params.event.name)) return // library marker zwaveTools.endpointTools, line 129

			if (it.hasAttribute(params.event.name) || (params.sendEveryEventType) || params.alwaysSend?.contains(params.event.name) ) {  // library marker zwaveTools.endpointTools, line 131
				it.sendEvent(params.event)  // library marker zwaveTools.endpointTools, line 132
				targetNotified = true // library marker zwaveTools.endpointTools, line 133
			} // library marker zwaveTools.endpointTools, line 134
		} // library marker zwaveTools.endpointTools, line 135
		if (! targetNotified) { // library marker zwaveTools.endpointTools, line 136
				if (sendEventNotHandledError) sendEventNotHandledError(params.event) // library marker zwaveTools.endpointTools, line 137
			} // library marker zwaveTools.endpointTools, line 138
	} // library marker zwaveTools.endpointTools, line 139
} // library marker zwaveTools.endpointTools, line 140

// Debugging Functions // library marker zwaveTools.endpointTools, line 142
void showEndpointlDataRecord() { // library marker zwaveTools.endpointTools, line 143
	// Debugging function - shows the entire concurrent @Field 'global' data record for all devices using a particular driver // library marker zwaveTools.endpointTools, line 144
	log.debug "Endpoint Data record is ${fullEndpointRecord.inspect()}." // library marker zwaveTools.endpointTools, line 145
} // library marker zwaveTools.endpointTools, line 146
...
library ( // library marker zwaveTools.batteryTools, line 1
		...
		dependencies: "", // library marker zwaveTools.batteryTools, line 10
...
void zwaveEvent(hubitat.zwave.commands.batteryv1.BatteryReport cmd) { processBatteryEvent(cmd) } // library marker zwaveTools.batteryTools, line 16
void zwaveEvent(hubitat.zwave.commands.batteryv2.BatteryReport cmd)  { processBatteryEvent(cmd) } // library marker zwaveTools.batteryTools, line 17
void zwaveEvent(hubitat.zwave.commands.batteryv3.BatteryReport cmd)  { processBatteryEvent(cmd) } // library marker zwaveTools.batteryTools, line 18
void processBatteryEvent(cmd)  // library marker zwaveTools.batteryTools, line 19
{ // library marker zwaveTools.batteryTools, line 20
	if (cmd.batteryLevel == 0xFF) { // library marker zwaveTools.batteryTools, line 21
		batteryEvent = [name: "battery", value:1, unit: "%", descriptionText: "Low Battery Alert. Change now!"] // library marker zwaveTools.batteryTools, line 22
	} else { // library marker zwaveTools.batteryTools, line 23
		batteryEvent = [name: "battery", value:cmd.batteryLevel, unit: "%", descriptionText: "Battery level report."] // library marker zwaveTools.batteryTools, line 24
	} // library marker zwaveTools.batteryTools, line 25
	sendEventToAll(event:batteryEvent, alwaysSend:["battery"]) // library marker zwaveTools.batteryTools, line 26
} // library marker zwaveTools.batteryTools, line 27

void batteryTools_refreshBattery() { // library marker zwaveTools.batteryTools, line 29
	advancedZwaveSend(zwave.batteryV1.batteryGet())  // library marker zwaveTools.batteryTools, line 30
} // library marker zwaveTools.batteryTools, line 31
...
[ // library marker zwaveTools.zwaveDeviceDatabase, line 29
	...
	[ // library marker zwaveTools.zwaveDeviceDatabase, line 74
		...
		endpoints:[ // library marker zwaveTools.zwaveDeviceDatabase, line 82
				0:[ children:[	[type:'Generic Component Central Scene Dimmer', 'namespace':'hubitat', childName:"Dimmer 0"], // library marker zwaveTools.zwaveDeviceDatabase, line 83
								[type:'Generic Component Central Scene Dimmer', 'namespace':'hubitat', childName:"Dimmer 1"] // library marker zwaveTools.zwaveDeviceDatabase, line 84
								], // library marker zwaveTools.zwaveDeviceDatabase, line 85
					classes:[94, 134, 114, 90, 133, 89, 115, 38, 39, 112, 44, 43, 91, 122]] // library marker zwaveTools.zwaveDeviceDatabase, line 86
				], // library marker zwaveTools.zwaveDeviceDatabase, line 87
		deviceInputs:[ // library marker zwaveTools.zwaveDeviceDatabase, line 88
			4:[ size:1,	category:"basic", name:"4", title:"(4) Orientation", description:"Control the on/off orientation of the rocker switch", options:[0:"Normal", 1:"Inverted"], type:"enum" ], // library marker zwaveTools.zwaveDeviceDatabase, line 89

			7:[ size:1,	category:"basic", name:"7", title:"(7) Remote Dimming Level Increment", range:"1..99", type:"number"], // library marker zwaveTools.zwaveDeviceDatabase, line 91
			8:[ size:2,	category:"basic", name:"8", title:"(8) Remote Dimming Level Duration", description:"Time interval (in tens of ms) of each brightness level change when controlled locally", range:"0..255", type:"number" ], // library marker zwaveTools.zwaveDeviceDatabase, line 92
			9:[ size:1,	category:"basic", name:"9", title:"(9) Local Dimming Level Increment", range:"1..99", type:"number"], // library marker zwaveTools.zwaveDeviceDatabase, line 93
			10:[size:2, category:"basic", name:"10", title:"(10) Local Dimming Level Duration", description:"Time interval (in tens of ms) of each brightness level change when controlled locally", range:"0..255", type:"number"] // library marker zwaveTools.zwaveDeviceDatabase, line 94
		] // library marker zwaveTools.zwaveDeviceDatabase, line 95
	], // library marker zwaveTools.zwaveDeviceDatabase, line 96
	[ // library marker zwaveTools.zwaveDeviceDatabase, line 97

		formatVersion:1,  // library marker zwaveTools.zwaveDeviceDatabase, line 99
		fingerprints: [ // library marker zwaveTools.zwaveDeviceDatabase, line 100
				[manufacturer:0x000C, 	deviceId: 0x3033,  deviceType:0x4447, name:"HomeSeer WS100 Switch"], // library marker zwaveTools.zwaveDeviceDatabase, line 101
				], // library marker zwaveTools.zwaveDeviceDatabase, line 102
		classVersions:[44:1, 89:1, 37:1, 39:1, 0:1, 122:1, 133:1, 112:1, 134:1, 114:1, 115:1, 90:1, 91:1, 94:1, 32:1, 43:1],  // library marker zwaveTools.zwaveDeviceDatabase, line 103
		endpoints:[	 // library marker zwaveTools.zwaveDeviceDatabase, line 104
					0:[children:[ [type:'Generic Component Central Scene Dimmer', 'namespace':'hubitat']	], // library marker zwaveTools.zwaveDeviceDatabase, line 105
						classes:[0, 32, 37, 39, 43, 44, 89, 90, 91, 94, 112, 114, 115, 122, 133, 134]] // library marker zwaveTools.zwaveDeviceDatabase, line 106
				],  // library marker zwaveTools.zwaveDeviceDatabase, line 107
		deviceInputs:[ // library marker zwaveTools.zwaveDeviceDatabase, line 108
			3:[ size:1, level:"basic", name:"3", title:"(3) LED Indication Configuration", options:[0:"LED On when device is Off", 1:"LED On when device is On", 2:"LED always Off", 4:"LED always On"], type:"enum" ], // library marker zwaveTools.zwaveDeviceDatabase, line 109
			4:[ size:1, level:"advanced", name:"4", title:"(4) Orientation", description:"Controls the on/off orientation of the rocker switch", options:[0:"Normal", 1:"Inverted"], type:"enum"], // library marker zwaveTools.zwaveDeviceDatabase, line 110
		] // library marker zwaveTools.zwaveDeviceDatabase, line 111
	], // library marker zwaveTools.zwaveDeviceDatabase, line 112
	[ // library marker zwaveTools.zwaveDeviceDatabase, line 113
		formatVersion:1,  // library marker zwaveTools.zwaveDeviceDatabase, line 114
		fingerprints:[[manufacturer:12, deviceId:12342, deviceType:17479, name:'HomeSeer Technologies: HS-WD200+']],  // library marker zwaveTools.zwaveDeviceDatabase, line 115
		classVersions:[44:1, 89:1, 38:3, 39:1, 0:1, 122:1, 133:2, 112:1, 134:2, 114:1, 115:1, 90:1, 91:3, 94:1, 32:1, 43:1],  // library marker zwaveTools.zwaveDeviceDatabase, line 116
		endpoints:[ // library marker zwaveTools.zwaveDeviceDatabase, line 117
					0:[	children:[ [type:'Generic Component Central Scene Dimmer', 'namespace':'hubitat']	], // library marker zwaveTools.zwaveDeviceDatabase, line 118
						classes:[0, 32, 38, 39, 43, 44, 89, 90, 91, 94, 112, 114, 115, 122, 133, 134]] // library marker zwaveTools.zwaveDeviceDatabase, line 119
				],  // library marker zwaveTools.zwaveDeviceDatabase, line 120
		deviceInputs:[ // Firmware 5.14 and above! // library marker zwaveTools.zwaveDeviceDatabase, line 121
			3:[size:1, name:'3', options:['0':'Bottom LED ON if load is OFF', '1':'Bottom LED OFF if load is OFF'], title:'(3) Bottom LED Operation', type:'enum'],  // library marker zwaveTools.zwaveDeviceDatabase, line 122
			4:[size:1, name:'4', options:['0':'Normal - Top of Paddle turns load ON', '1':'Inverted - Bottom of Paddle turns load ON'], title:'(4) Paddle Orientation', type:'enum'],  // library marker zwaveTools.zwaveDeviceDatabase, line 123
			5:[size:1, name:'5', options:['0':'(0) No minimum set', '1':'(1) 6.5%', '2':'(2) 8%', '3':'(3) 9%', '4':'(4) 10%', '5':'(5) 11%', '6':'(6) 12%', '7':'(7) 13%', '8':'(8) 14%', '9':'(9) 15%', '10':'(10) 16%', '11':'(11) 17%', '12':'(12) 18%', '13':'(13) 19%', '14':'(14) 20%'], title:'(5) Minimum Dimming Level', type:'enum'], // library marker zwaveTools.zwaveDeviceDatabase, line 124
 			6:[size:1, name:'6', options:['0':'Central Scene Enabled', '1':'Central Scene Disabled'], title:'(5) Central Scene Enable/Disable', type:'enum'], 			 // library marker zwaveTools.zwaveDeviceDatabase, line 125
			11:[size:1, name:'11', range:'0..90', title:'(11) Set dimmer ramp rate for remote control (seconds)', type:'number'],  // library marker zwaveTools.zwaveDeviceDatabase, line 126
			12:[size:1, name:'12', range:'0..90', title:'(12) Set dimmer ramp rate for local control (seconds)', type:'number'],  // library marker zwaveTools.zwaveDeviceDatabase, line 127
			13:[size:1, name:'13', options:['0':'LEDs show load status', '1':'LEDs display a custom status'], description:'Set dimmer display mode', title:'(13) Status Mode', type:'enum'], 	 // library marker zwaveTools.zwaveDeviceDatabase, line 128
			14:[size:1, name:'14', options:['0':'White', '1':'Red', '2':'Green', '3':'Blue', '4':'Magenta', '5':'Yellow', '6':'Cyan'], title:'(14) Set the LED color when displaying load status', type:'enum'], 		 // library marker zwaveTools.zwaveDeviceDatabase, line 129
			21:[size:1, name:'21', options:['0':'Off', '1':'Red', '2':'Green', '3':'Blue', '4':'Magenta', '5':'Yellow', '6':'Cyan', '7':'White'], title:'(21) Status LED 1 Color (bottom LED)', type:'enum'], // library marker zwaveTools.zwaveDeviceDatabase, line 130
			22:[size:1, name:'22', options:['0':'Off', '1':'Red', '2':'Green', '3':'Blue', '4':'Magenta', '5':'Yellow', '6':'Cyan', '7':'White'], title:'(22) Status LED 2 Color', type:'enum'],  // library marker zwaveTools.zwaveDeviceDatabase, line 131
			23:[size:1, name:'23', options:['0':'Off', '1':'Red', '2':'Green', '3':'Blue', '4':'Magenta', '5':'Yellow', '6':'Cyan', '7':'White'], title:'(23) Status LED 3 Color', type:'enum'],  // library marker zwaveTools.zwaveDeviceDatabase, line 132

			24:[size:1, name:'24', options:['0':'Off', '1':'Red', '2':'Green', '3':'Blue', '4':'Magenta', '5':'Yellow', '6':'Cyan', '7':'White'], title:'(24) Status LED 4 Color', type:'enum'],  // library marker zwaveTools.zwaveDeviceDatabase, line 134

			25:[size:1, name:'25', options:['0':'Off', '1':'Red', '2':'Green', '3':'Blue', '4':'Magenta', '5':'Yellow', '6':'Cyan', '7':'White'], title:'(25) Status LED 5 Color', type:'enum'],  // library marker zwaveTools.zwaveDeviceDatabase, line 136
			26:[size:1, name:'26', options:['0':'Off', '1':'Red', '2':'Green', '3':'Blue', '4':'Magenta', '5':'Yellow', '6':'Cyan', '7':'White'], title:'(26) Status LED 6 Color', type:'enum'],  // library marker zwaveTools.zwaveDeviceDatabase, line 137
			27:[size:1, name:'27', options:['0':'Off', '1':'Red', '2':'Green', '3':'Blue', '4':'Magenta', '5':'Yellow', '6':'Cyan', '7':'White'], title:'(27) Status LED 7 Color (top LED)', type:'enum'],  // library marker zwaveTools.zwaveDeviceDatabase, line 138
			30:[size:1, name:'30', range:'0..255', title:'(30) Blink Frequency when displaying custom status', type:'number'],  // library marker zwaveTools.zwaveDeviceDatabase, line 139
			31:[size:1, name:'31', type:'number', title:'(31) LED 7 Blink Status - bitmap', description:'bitmap defines LEDs to blink '],  // library marker zwaveTools.zwaveDeviceDatabase, line 140

		] // library marker zwaveTools.zwaveDeviceDatabase, line 142
	], // library marker zwaveTools.zwaveDeviceDatabase, line 143
	[ // library marker zwaveTools.zwaveDeviceDatabase, line 144
		formatVersion:1,  // library marker zwaveTools.zwaveDeviceDatabase, line 145
		fingerprints:[ // library marker zwaveTools.zwaveDeviceDatabase, line 146
			[manufacturer:12, deviceId:12341, deviceType:17479, name:'HomeSeer Technologies: HS-WS200+'] // library marker zwaveTools.zwaveDeviceDatabase, line 147
			],  // library marker zwaveTools.zwaveDeviceDatabase, line 148
		classVersions:[44:1, 89:1, 37:1, 39:1, 0:1, 122:1, 133:2, 112:1, 134:2, 114:1, 115:1, 90:1, 91:3, 94:1, 32:1, 43:1],  // library marker zwaveTools.zwaveDeviceDatabase, line 149
		endpoints:[ // library marker zwaveTools.zwaveDeviceDatabase, line 150
					0:[	children:[ [type:'Generic Component Central Scene Switch', 'namespace':'hubitat']	], // library marker zwaveTools.zwaveDeviceDatabase, line 151
						classes:[0, 32, 37, 39, 43, 44, 89, 90, 91, 94, 112, 114, 115, 122, 133, 134]] // library marker zwaveTools.zwaveDeviceDatabase, line 152
				],  // library marker zwaveTools.zwaveDeviceDatabase, line 153
		deviceInputs:[ // library marker zwaveTools.zwaveDeviceDatabase, line 154
			3:[size:1, name:'3', options:[0:'LED ON if load is OFF', '1':'LED OFF if load is OFF'], description:'Sets LED operation (in normal mode)', title:'(3) Bottom LED Operation', type:'enum'],  // library marker zwaveTools.zwaveDeviceDatabase, line 155
			4:[size:1, name:'4', options:[0:'Top of Paddle turns load ON', '1':'Bottom of Paddle turns load ON'], description:'Sets paddle’s load orientation', title:'(4) Orientation', type:'enum'],  // library marker zwaveTools.zwaveDeviceDatabase, line 156
			6:[size:1, name:'6', options:[0:'Disabled', '1':'Enabled'], description:'Enable or Disable Scene Control', title:'(6) Scene Control', type:'enum'],  // library marker zwaveTools.zwaveDeviceDatabase, line 157
			13:[size:1, name:'13', options:[0:'Normal mode (load status)', '1':'Status mode (custom status)'], description:'Sets switch mode of operation', title:'(13) Status Mode', type:'enum'],  // library marker zwaveTools.zwaveDeviceDatabase, line 158
			14:[size:1, name:'14', options:['0':'White', '1':'Red', '2':'Green', '3':'Blue', '4':'Magenta', '5':'Yellow', '6':'Cyan'], description:'Sets the Normal mode LED color', title:'(14) Load Status LED Color', type:'enum'],  // library marker zwaveTools.zwaveDeviceDatabase, line 159
			21:[size:1, name:'21', options:['0':'Off', '1':'Red', '2':'Green', '3':'Blue', '4':'Magenta', '5':'Yellow', '6':'Cyan', '7':'White'], description:'Sets the Status mode LED color', title:'(21) Status LED Color', type:'enum'], // library marker zwaveTools.zwaveDeviceDatabase, line 160
			31:[size:1, name:'31', description:'Sets the switch LED Blink frequency', range:'0..255', title:'(31) Blink Frequency', type:'number'], // library marker zwaveTools.zwaveDeviceDatabase, line 161
		] // library marker zwaveTools.zwaveDeviceDatabase, line 162
	], // library marker zwaveTools.zwaveDeviceDatabase, line 163
	[ // library marker zwaveTools.zwaveDeviceDatabase, line 164
		formatVersion:1,  // library marker zwaveTools.zwaveDeviceDatabase, line 165
		fingerprints:[ // library marker zwaveTools.zwaveDeviceDatabase, line 166
			[manufacturer:99, deviceId:12597, deviceType:18770, name:'Jasco Products: 46201'] // library marker zwaveTools.zwaveDeviceDatabase, line 167
			],  // library marker zwaveTools.zwaveDeviceDatabase, line 168
		classVersions:[44:1, 34:1, 89:1, 37:1, 0:1, 122:1, 133:2, 112:1, 134:2, 114:1, 115:1, 90:1, 91:3, 94:1, 32:1, 43:1],  // library marker zwaveTools.zwaveDeviceDatabase, line 169
		endpoints:[ // library marker zwaveTools.zwaveDeviceDatabase, line 170
				0:[	children:[ [type:'Generic Component Central Scene Switch', 'namespace':'hubitat']	], // library marker zwaveTools.zwaveDeviceDatabase, line 171
					classes:[0, 32, 34, 37, 43, 44, 89, 90, 91, 94, 112, 114, 115, 122, 133, 134]] // library marker zwaveTools.zwaveDeviceDatabase, line 172
			],  // library marker zwaveTools.zwaveDeviceDatabase, line 173
		deviceInputs:[ // library marker zwaveTools.zwaveDeviceDatabase, line 174
			3:[size:1, name:'3', range:'0..255', title:'(3) Blue LED Night Light', type:'number'] // library marker zwaveTools.zwaveDeviceDatabase, line 175
		] // library marker zwaveTools.zwaveDeviceDatabase, line 176
	], // library marker zwaveTools.zwaveDeviceDatabase, line 177
	[ // library marker zwaveTools.zwaveDeviceDatabase, line 178
		formatVersion:1,  // library marker zwaveTools.zwaveDeviceDatabase, line 179
		fingerprints:[[manufacturer:99, deviceId:12338, deviceType:20292, name:'GE/Jasco Heavy Duty Switch 14285']],  // library marker zwaveTools.zwaveDeviceDatabase, line 180
		classVersions:[44:1, 89:1, 37:1, 0:1, 122:1, 133:2, 112:1, 134:2, 114:1, 115:1, 90:1, 91:3, 50:3, 94:1, 32:1, 43:1],  // library marker zwaveTools.zwaveDeviceDatabase, line 181
		endpoints:[ // library marker zwaveTools.zwaveDeviceDatabase, line 182
				0:[	children:[ [type:'Generic Component Central Scene Switch', 'namespace':'hubitat']	], // library marker zwaveTools.zwaveDeviceDatabase, line 183
					classes:[0, 32, 37, 43, 44, 50, 89, 90, 91, 94, 112, 114, 115, 122, 133, 134],  // library marker zwaveTools.zwaveDeviceDatabase, line 184
					metersSupported:[0, 2, 4, 5, 6]] // library marker zwaveTools.zwaveDeviceDatabase, line 185
			],  // library marker zwaveTools.zwaveDeviceDatabase, line 186
		deviceInputs:[ // library marker zwaveTools.zwaveDeviceDatabase, line 187
			1:[size:1, name:'1', options:['0':'Return to last state', '1':'Return to off', '2':'Return to on'], title:'(1) Product State after Power Reset', type:'enum'],  // library marker zwaveTools.zwaveDeviceDatabase, line 188
			2:[size:1, name:'2', options:['0':'Once monthly', '1':'Reports based on Parameter 3 setting', '2':'Once daily'], title:'(2) Energy Report Mode', type:'enum'],  // library marker zwaveTools.zwaveDeviceDatabase, line 189
			3:[size:1, name:'3', range:'5..60', title:'(3) Energy Report Frequency', type:'number'],  // library marker zwaveTools.zwaveDeviceDatabase, line 190
			19:[size:1, name:'19', options:['0':'Default', '1':'Alternate Exclusion (3 button presses)'], title:'(19) Alternate Exclusion', type:'enum'] // library marker zwaveTools.zwaveDeviceDatabase, line 191
			] // library marker zwaveTools.zwaveDeviceDatabase, line 192
	], // library marker zwaveTools.zwaveDeviceDatabase, line 193
	[ // library marker zwaveTools.zwaveDeviceDatabase, line 194
		formatVersion:1,  // library marker zwaveTools.zwaveDeviceDatabase, line 195
		fingerprints:[ // library marker zwaveTools.zwaveDeviceDatabase, line 196
				[manufacturer:634, deviceId:40963, deviceType:40960, name:'Zooz: ZEN25'] // library marker zwaveTools.zwaveDeviceDatabase, line 197
			],  // library marker zwaveTools.zwaveDeviceDatabase, line 198
		classVersions:[0:1, 32:1, 37:1, 50:3, 89:1, 90:1, 94:1, 96:2, 112:1, 113:8, 114:1, 115:1, 122:1, 133:2, 134:2, 142:3],  // library marker zwaveTools.zwaveDeviceDatabase, line 199
		endpoints:[ // library marker zwaveTools.zwaveDeviceDatabase, line 200
				0:[	classes:[0, 32, 37, 50, 89, 90, 94, 96, 112, 113, 114, 115, 122, 133, 134, 142]],  // library marker zwaveTools.zwaveDeviceDatabase, line 201
	...
	[ // library marker zwaveTools.zwaveDeviceDatabase, line 279
		formatVersion:1, 'fingerprints':[['manufacturer':634, 'deviceId':40961, 'deviceType':40960, name:'Zooz: ZEN26']],  // library marker zwaveTools.zwaveDeviceDatabase, line 280
		classVersions:[89:1, 37:1, 142:3, 0:1, 122:1, 133:2, 112:1, 134:2, 114:1, 115:1, 90:1, 91:3, 94:1, 32:1],  // library marker zwaveTools.zwaveDeviceDatabase, line 281
		endpoints:[ 0:[ // library marker zwaveTools.zwaveDeviceDatabase, line 282
						children:[ [type:'Generic Component Central Scene Switch', 'namespace':'hubitat']	], // library marker zwaveTools.zwaveDeviceDatabase, line 283
						classes:[0, 32, 37, 89, 90, 91, 94, 112, 114, 115, 122, 133, 134, 142]] // library marker zwaveTools.zwaveDeviceDatabase, line 284
				],  // library marker zwaveTools.zwaveDeviceDatabase, line 285
		deviceInputs:[ // library marker zwaveTools.zwaveDeviceDatabase, line 286
			11:[size:1, name:'11', options:['0':'Local control disabled', '1':'Local control enabled'], description:'Enable or disable local ON/OFF control', title:'(11) Enable/disable paddle control', type:'enum'],  // library marker zwaveTools.zwaveDeviceDatabase, line 287
			1:[size:1, name:'1', description:'Choose paddle functionality (invert)', range:'0..1', title:'(1) Paddle control', type:'number'],  // library marker zwaveTools.zwaveDeviceDatabase, line 288
			2:[size:1, name:'2', options:['0':'LED ON when switch OFF', '1':'LED ON when switch ON', '2':'LED OFF', '3':'LED ON'], description:'Change behavior of the LED indicator', title:'(2) LED indicator control', type:'enum'],  // library marker zwaveTools.zwaveDeviceDatabase, line 289
			3:[size:1, name:'3', options:['0':'Disable', '1':'Enable'], description:'Enable/disable turn-OFF timer', title:'(3) Auto turn-OFF timer', type:'enum'],  // library marker zwaveTools.zwaveDeviceDatabase, line 290
			4:[size:4, name:'4', description:'Length of time before switch turns OFF', range:'0..65535', title:'(4) Auto turn-OFF timer length', type:'number'],  // library marker zwaveTools.zwaveDeviceDatabase, line 291
			5:[size:1, name:'5', options:['0':'Disable', '1':'Enable'], description:'Enable/disable turn-ON timer', title:'(5) Auto turn-ON timer', type:'enum'],  // library marker zwaveTools.zwaveDeviceDatabase, line 292
			6:[size:4, name:'6', description:'Length of time before switch turns ON', range:'0..65535', title:'(6) Auto turn-ON timer length', type:'number'],  // library marker zwaveTools.zwaveDeviceDatabase, line 293
			7:[size:1, name:'7', options:['11':'Physical tap ZEN26, 3-way switch or timer', '12':'Z-Wave command or timer', '13':'Physical tap ZEN26, Z-Wave or timer', '14':'Physical tap ZEN26, 3-way switch, Z-Wave or timer', '15':'All of the above', '0':'None', '1':'Physical tap ZEN26 only', '2':'Physical tap 3-way switch only', '3':'Physical tap ZEN26 or 3-way switch', '4':'Z-Wave command', '5':'Physical tap ZEN26 or Z-Wave', '6':'Physical tap 3-way switch or Z-Wave', '7':'Physical tap ZEN26, 3-way switch or Z-Wave', '8':'Timer only', '9':'Physical tap ZEN26 or timer', '10':'Physical tap 3-way switch or timer'], title:'(7) Association reports', type:'enum'],  // library marker zwaveTools.zwaveDeviceDatabase, line 294
			8:[size:1, name:'8', options:['0':'OFF', '1':'ON', '2':'Restore last state'], description:'Set the ON/OFF status for the switch after power failure', title:'(8) ON/OFF status after power failure', type:'enum'],  // library marker zwaveTools.zwaveDeviceDatabase, line 295
			10:[size:1, name:'10', options:['0':'Scene control disabled', '1':'Scene control enabled'], title:'(10) Enable/disable scene control', type:'enum'] // library marker zwaveTools.zwaveDeviceDatabase, line 296
	...
	[ // library marker zwaveTools.zwaveDeviceDatabase, line 299
		formatVersion:1,  // library marker zwaveTools.zwaveDeviceDatabase, line 300
		fingerprints:[ // library marker zwaveTools.zwaveDeviceDatabase, line 301
				['manufacturer':634, 'deviceId':40968, 'deviceType':40960, name:'Zooz: ZEN30'] // Zooz Zen 30 // library marker zwaveTools.zwaveDeviceDatabase, line 302
			],  // library marker zwaveTools.zwaveDeviceDatabase, line 303
		classVersions:[0:1, 32:1, 37:1, 38:3, 89:1, 90:1, 91:3, 94:1, 96:2, 112:1, 114:1, 115:1, 122:1, 133:2, 134:2, 142:3, 152:2],  // library marker zwaveTools.zwaveDeviceDatabase, line 304
		endpoints:[ // library marker zwaveTools.zwaveDeviceDatabase, line 305
					0:[ // library marker zwaveTools.zwaveDeviceDatabase, line 306
						children:[ [type:'Generic Component Central Scene Dimmer', 'namespace':'hubitat']	], // library marker zwaveTools.zwaveDeviceDatabase, line 307
						classes:[0, 32, 37, 38, 89, 90, 91, 94, 96, 112, 114, 115, 122, 133, 134, 142, 152]],  // library marker zwaveTools.zwaveDeviceDatabase, line 308
					1:[ children:[[type:'Generic Component Switch', namespace:'hubitat', childName:"Relay Switch"]],  // library marker zwaveTools.zwaveDeviceDatabase, line 309
						classes:[32, 37, 89, 94, 133, 142]] // library marker zwaveTools.zwaveDeviceDatabase, line 310
				],  // library marker zwaveTools.zwaveDeviceDatabase, line 311
		deviceInputs:[ // library marker zwaveTools.zwaveDeviceDatabase, line 312
			1:[name:'1', title:'(1) LED Indicator Mode for Dimmer', size:1, type:'enum', options:[0:'ON when switch is OFF and OFF when switch is ON', 1:'ON when switch is ON and OFF when switch is OFF', 2:'LED indicator is always OFF', 3:'LED indicator is always ON']],  // library marker zwaveTools.zwaveDeviceDatabase, line 313
			2:[name:'2', title:'(2) LED Indicator Control for Relay', size:1, type:'enum', options:[0:'ON when relay is OFF and OFF when relay is ON', 1:'ON when relay is ON and OFF when relay is OFF', 2:'LED indicator is always OFF', 3:'LED indicator is always ON']],  // library marker zwaveTools.zwaveDeviceDatabase, line 314
			3:[name:'3', title:'(3) LED Indicator Color for Dimmer', size:1, description:'Choose the color of the LED indicators for the dimmer', type:'enum', options:[0:'White (default)', 1:'Blue', 2:'Green', 3:'Red']],  // library marker zwaveTools.zwaveDeviceDatabase, line 315
			4:[name:'4', title:'(4) LED Indicator Color for Relay', size:1, type:'enum', options:[0:'White (default)', 1:'Blue', 2:'Green', 3:'Red']],  // library marker zwaveTools.zwaveDeviceDatabase, line 316
			5:[name:'5', title:'(5) LED Indicator Brightness for Dimmer', size:1, type:'enum', options:[0:'Bright (100%)', 1:'Medium (60%)', 2:'Low (30% - default)']],  // library marker zwaveTools.zwaveDeviceDatabase, line 317
			6:[name:'6', title:'(6) LED Indicator Brightness for Relay', size:1, type:'enum', options:[0:'Bright (100%)', 1:'Medium (60%)', 2:'Low (30% - default)']],  // library marker zwaveTools.zwaveDeviceDatabase, line 318
			7:[name:'7', title:'(7) LED Indicator Mode for Scene Control', size:1, type:'enum', options:[0:'Enabled to indicate scene triggers', 1:'Disabled to indicate scene triggers (default)']],  // library marker zwaveTools.zwaveDeviceDatabase, line 319
			8:[name:'8', title:'(8) Auto Turn-Off Timer for Dimmer', size:4, type:'number', range:"0..65535"],  // library marker zwaveTools.zwaveDeviceDatabase, line 320
			9:[name:'9', title:'(9) Auto Turn-On Timer for Dimmer', size:4, type:'number', range:"0..65535"],  // library marker zwaveTools.zwaveDeviceDatabase, line 321
			10:[name:'10', title:'(10) Auto Turn-Off Timer for Relay', size:4, type:'number', range:"0..65535"],  // library marker zwaveTools.zwaveDeviceDatabase, line 322
			11:[name:'11', title:'(11) Auto Turn-On Timer for Relay', size:4, type:'number', range:"0..65535"],  // library marker zwaveTools.zwaveDeviceDatabase, line 323
			12:[name:'12', title:'(12) On Off Status After Power Failure', size:1, type:'enum', options:[0:'Dimmer and relay forced to OFF', 1:'Dimmer forced to OFF, relay forced to ON', 2:'Dimmer forced to ON, relay forced to OFF', 3:'Restores status for dimmer and relay (default)', 4:'Restores status for dimmer, relay forced to ON', 5:'Restores status for dimmer, relay forced to OFF', 6:'Dimmer forced to ON, restores status for relay', 7:'Dimmer forced to OFF, restores status for relay', 8:'Dimmer and relay forced to ON']],  // library marker zwaveTools.zwaveDeviceDatabase, line 324
			13:[name:'13', title:'(13) Ramp Rate Control for Dimmer', size:1, type:'number', range:"0..99"],  // library marker zwaveTools.zwaveDeviceDatabase, line 325
			14:[name:'14', title:'(14) Minimum Brightness', size:1, type:'number', range:"1..99"],  // library marker zwaveTools.zwaveDeviceDatabase, line 326
			15:[name:'15', title:'(15) Maximum Brightness', size:1, type:'number', range:"1..99"],  // library marker zwaveTools.zwaveDeviceDatabase, line 327
			17:[name:'17', title:'(17) Double Tap Function for Dimmer', size:1, type:'enum', options:[0:'ON to full brightness with double tap (default)', 1:'ON to brightness set in #15 with double tap']],  // library marker zwaveTools.zwaveDeviceDatabase, line 328
			18:[name:'18', title:'(18) Disable Double Tap', size:1, type:'enum', options:[0:'Full/max brightness level enabled (default)', 1:'Disabled, single tap for last brightness', 2:'Disabled, single tap to full brightness']],  // library marker zwaveTools.zwaveDeviceDatabase, line 329
			19:[name:'19', title:'(19) Smart Bulb Setting', size:1, description:'Enable/Disable Load Control for Dimmer', type:'enum', options:[0:'Manual control disabled', 1:'Manual control enabled (default)', 2:'Manual and Z-Wave control disabled']],  // library marker zwaveTools.zwaveDeviceDatabase, line 330
			20:[name:'20', title:'(20) Remote Control Setting', size:1, description:'Enable/Disable Load Control for Relay', type:'enum', options:[0:'Manual control disabled', 1:'Manual control enabled (default)', 2:'Manual and Z-Wave control disabled']],  // library marker zwaveTools.zwaveDeviceDatabase, line 331
			21:[name:'21', title:'(21) Manual Dimming Speed', size:1, type:'number', range:"1..99"],  // library marker zwaveTools.zwaveDeviceDatabase, line 332
			// 22:[name:'22', title:'(22) Z-Wave Ramp Rate for Dimmer', size:1, type:'enum', options:[0:'Match #13', 1:'Set through Command Class']],  // library marker zwaveTools.zwaveDeviceDatabase, line 333
			23:[name:'23', title:'(23) Default Brightness Level ON for Dimmer', size:1, type:'number', range:"0..99"]	 // library marker zwaveTools.zwaveDeviceDatabase, line 334
...
List<Integer> getNotificationTypesList(def cmd) { // library marker zwaveTools.notificationTools, line 43
	...
	if (cmd.waterQuality)		notificationTypes += 21 // Water Quality // library marker zwaveTools.notificationTools, line 66
...
{ // library marker zwaveTools.notificationTools, line 84
	...
	Map notificationEvent = // library marker zwaveTools.notificationTools, line 86
		[ 	0x01:[ // Smoke // library marker zwaveTools.notificationTools, line 87
			...
			0x09:[ // System // library marker zwaveTools.notificationTools, line 201
				5:[name:"heartbeat" , value:currentDate, descriptionText:"Last Heartbeat"] // library marker zwaveTools.notificationTools, line 202
				], 				 // library marker zwaveTools.notificationTools, line 203
			0x12:[ //  Gas Alarm // library marker zwaveTools.notificationTools, line 204
				0:[	 // These events "clear" a sensor.	 // library marker zwaveTools.notificationTools, line 205
						1:[name:"naturalGas" , value:"clear", descriptionText:"Combustible gas (cleared) (location provided)"], 	 // library marker zwaveTools.notificationTools, line 206
						2:[name:"naturalGas" , value:"clear", descriptionText:"Combustible gas  (cleared) "],  // library marker zwaveTools.notificationTools, line 207
						5:[name:"naturalGas" , value:"clear", descriptionText:"Gas detector test completed."], 	 // library marker zwaveTools.notificationTools, line 208
						6:[name:"consumableStatus" , value:"good", descriptionText:"Gas detector (good)"], // library marker zwaveTools.notificationTools, line 209
					],  // library marker zwaveTools.notificationTools, line 210
				1:[name:"naturalGas" , value:"detected", descriptionText:"Combustible gas detected (location provided)"], 	 // library marker zwaveTools.notificationTools, line 211
				2:[name:"naturalGas" , value:"detected", descriptionText:"Combustible gas detected"],  // library marker zwaveTools.notificationTools, line 212
				5:[name:"naturalGas" , value:"tested", descriptionText:"Gas detector test"], 	 // library marker zwaveTools.notificationTools, line 213
				6:[name:"consumableStatus" , value:"replace", descriptionText:"Gas detector, replacement required"], // library marker zwaveTools.notificationTools, line 214
				],				 // library marker zwaveTools.notificationTools, line 215
			0x0E:[ // Siren // library marker zwaveTools.notificationTools, line 216
				0:[ // library marker zwaveTools.notificationTools, line 217
						1:[name:"alarm" , value:"off", descriptionText:"Alarm Siren Off."] // library marker zwaveTools.notificationTools, line 218
					],  // library marker zwaveTools.notificationTools, line 219
				1:[name:"alarm" , value:"siren", descriptionText:"Alarm Siren On."] // library marker zwaveTools.notificationTools, line 220
				],  // library marker zwaveTools.notificationTools, line 221
			0x0F:[ // Water Valve // library marker zwaveTools.notificationTools, line 222
				0:[name:"valve" , value:( (cmd.event > 0 ) ? "open" : "closed"), descriptionText:"Valve Operation."],  // library marker zwaveTools.notificationTools, line 223
				1:[name:"valve" , value:( (cmd.event > 0 ) ? "open" : "closed"), descriptionText:"Master Valve Operation."]  // library marker zwaveTools.notificationTools, line 224
				],  // library marker zwaveTools.notificationTools, line 225

			0x16:[ // Home Monitoring // library marker zwaveTools.notificationTools, line 227
				0:[ // library marker zwaveTools.notificationTools, line 228
						1:[name:"presence" , value:"not present", descriptionText:"Home not occupied"], // library marker zwaveTools.notificationTools, line 229
						2:[name:"presence" , value:"not present", descriptionText:"Home not occupied"] // library marker zwaveTools.notificationTools, line 230
					],  // library marker zwaveTools.notificationTools, line 231
				1:[name:"presence" , value:"present", descriptionText:"Home occupied (location provided)"],   // library marker zwaveTools.notificationTools, line 232
				2:[name:"presence" , value:"present", descriptionText:"Home occupied"] // library marker zwaveTools.notificationTools, line 233
				] // library marker zwaveTools.notificationTools, line 234

		].get((Integer) cmd.notificationType )?.get((Integer) cmd.event ) // library marker zwaveTools.notificationTools, line 236

		if (notificationEvent.is( null ))  // library marker zwaveTools.notificationTools, line 238
		{ // library marker zwaveTools.notificationTools, line 239
		return [name:"unhandledZwaveEvent", value:cmd.format(), deviceType:"ZWV", zwaveOriginalMessage:cmd.format()] // library marker zwaveTools.notificationTools, line 240
		} // library marker zwaveTools.notificationTools, line 241

		if ((cmd.event == 0) && (cmd.eventParametersLength == 1)) { // This is for clearing events. // library marker zwaveTools.notificationTools, line 243
				return notificationEvent.get( (Integer) cmd.eventParameter[0] ) // library marker zwaveTools.notificationTools, line 244
		} // library marker zwaveTools.notificationTools, line 245

		if (cmd.eventParametersLength > 1) { // This is unexpected! None of the current notifications use this. // library marker zwaveTools.notificationTools, line 247
			log.error "In function getZWaveNotificationEvent(), received command with eventParametersLength of unexpected size." // library marker zwaveTools.notificationTools, line 248
			return null // library marker zwaveTools.notificationTools, line 249
		}  // library marker zwaveTools.notificationTools, line 250
		return notificationEvent // library marker zwaveTools.notificationTools, line 251
} // library marker zwaveTools.notificationTools, line 252

void zwaveEvent(hubitat.zwave.commands.notificationv8.NotificationReport cmd, Integer ep = null ) // library marker zwaveTools.notificationTools, line 254
{ // library marker zwaveTools.notificationTools, line 255
	if (userNotificationReportFilter) cmd = userNotificationReportFilter(cmd) // library marker zwaveTools.notificationTools, line 256

	Map thisEvent = getFormattedZWaveNotificationEvent(cmd) // library marker zwaveTools.notificationTools, line 258

	if (userNotificationEventFilter) thisEvent = userNotificationEventFilter(thisEvent) // library marker zwaveTools.notificationTools, line 260

	sendEventToEndpoints(event:thisEvent, ep:ep, alwaysSend:["heartbeat"]) // library marker zwaveTools.notificationTools, line 262
...
{ // library marker zwaveTools.meterTools, line 118
	Map thisEvent = getFormattedZWaveMeterReportEvent(cmd) // library marker zwaveTools.meterTools, line 119
	sendEventToEndpoints(event:thisEvent, ep:ep) // library marker zwaveTools.meterTools, line 120
} // library marker zwaveTools.meterTools, line 121
...
{ // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 39
	...
	List<Integer> supportedClasses = getThisEndpointClasses((Integer) params.ep) // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 41
...
void zwaveEvent(hubitat.zwave.commands.switchbinaryv2.SwitchBinaryReport cmd, Integer ep = null ) // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 57
{ // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 58
	...
	List <com.hubitat.app.DeviceWrapper> targetDevices = getChildDeviceListByEndpoint(ep)?.findAll{it.hasAttribute("switch")} // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 62
...
void zwaveEvent(hubitat.zwave.commands.switchmultilevelv4.SwitchMultilevelReport cmd, Integer ep = null ) { processSwitchReport(cmd, ep) } // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 72
void zwaveEvent(hubitat.zwave.commands.basicv2.BasicReport cmd, Integer ep = null ) { processSwitchReport(cmd, ep) } // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 73
void processSwitchReport(cmd, Integer ep) // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 74
{ // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 75
	...
	targetDevices.each{ targetDevice -> // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 79
		if (targetDevice.hasAttribute("position"))  // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 80
		{  // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 81
			targetDevice.sendEvent( name: "position", value: (cmd.value == 99 ? 100 : cmd.value) , unit: "%", descriptionText: "Position set", type: "physical" ) // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 82
		} // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 83
		if (targetDevice.hasAttribute("windowShade")) // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 84
		{ // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 85
			String positionDescription // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 86
			switch ((Integer) cmd.value ) // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 87
			{ // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 88
				case 0:  positionDescription = "closed" ; break // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 89
				case 99:  positionDescription = "open" ; break // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 90
				default : positionDescription = "partially open" ; break // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 91
			} // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 92
			targetDevice.sendEvent( name: "windowShade", value: positionDescription, descriptionText: "Window Shade position set.", type: "physical" )	 // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 93
		} // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 94

		if (targetDevice.hasAttribute("level") || targetDevice.hasAttribute("switch") ) // Switch or a fan // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 96
		{ // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 97
			Integer targetLevel = 0 // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 98

			if (cmd.hasProperty("targetValue")) //  Consider duration and target, but only when both are present and in transition with duration > 0  // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 100
			{ // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 101
				targetLevel = cmd.targetValue ?: cmd.value // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 102
			} else { // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 103
				targetLevel = cmd.value // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 104
			} // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 105

			String priorSwitchState = targetDevice.currentValue("switch") // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 107
			String newSwitchState = ((targetLevel != 0) ? "on" : "off") // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 108
			Integer priorLevel = targetDevice.currentValue("level") // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 109

			if ((targetLevel == 99) && (priorLevel == 100)) targetLevel = 100 // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 111

			if (targetDevice.hasAttribute("switch")) // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 113
			{ // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 114
				targetDevice.sendEvent(	name: "switch", value: newSwitchState, descriptionText: "Switch state set", type: "physical" ) // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 115
				if (txtEnable) log.info "Device ${targetDevice.displayName} set to ${newSwitchState}." // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 116
			} // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 117
			if (targetDevice.hasAttribute("speed"))  // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 118
			{ // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 119
				targetDevice.sendEvent( name: "speed", value: levelToSpeed(targetLevel), descriptionText: "Speed set", type: "physical" ) // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 120
			} // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 121
			if (targetDevice.hasAttribute("level") && (targetLevel != 0 )) // Only handle on values 1-99 here. If device was turned off, that would be handle in the switch state block above. // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 122
			{ // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 123
				targetDevice.sendEvent( name: "level", value: targetLevel, descriptionText: "Level set", unit:"%", type: "physical" ) // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 124
				if (txtEnable) log.info "Device ${targetDevice.displayName} level set to ${targetLevel}%"		 // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 125
			} // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 126
		} // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 127
...
void componentOn(com.hubitat.app.DeviceWrapper cd){ on(cd:cd) } // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 131

void on(Map params = [cd: null , duration: null , level: null ]) // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 133
{ // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 134
	Integer ep = getChildEndpointNumber(params.cd) // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 135

	sendEventToEndpoints(event:[name: "switch", value: "on", descriptionText: "Device turned off", type: "digital"] , ep:ep) // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 137

	Integer targetLevel = 100 // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 139
	if (params.level) { // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 140
		targetLevel = (params.level as Integer)  // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 141
	} else { // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 142
		List<com.hubitat.app.DeviceWrapper> targets = getChildDeviceListByEndpoint(ep) // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 143
		if (ep == 0) targets += device // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 144
		targetLevel = (targets?.find{it.hasAttribute("level")}?.currentValue("level") as Integer) ?: 100 // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 145
	} // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 146
	targetLevel = Math.min(Math.max(targetLevel, 1), 100) // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 147

	sendEventToEndpoints(event:[name: "level", value: targetLevel, descriptionText: "Device level set", unit:"%", type: "digital"], ep:ep) // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 149

	sendZwaveValue(value: targetLevel, duration: params.duration, ep: ep) // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 151
} // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 152

void componentOff(com.hubitat.app.DeviceWrapper cd){ 	off(cd:cd) } // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 154

void off(Map params = [cd: null , duration: null ]) { // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 156

	if (logDebug) "componentOff called with parameters ${params}" // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 158

	Integer ep = getChildEndpointNumber(params.cd) // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 160
	if (logDebug) "Chiled endpoint is ${ep}" // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 161

	sendEventToEndpoints(event:[name: "switch", value: "off", descriptionText: "Device turned off", type: "digital"], ep:ep) // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 163
	sendZwaveValue(value: 0, duration: params.duration, ep: ep) // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 164
} // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 165

void componentSetLevel(com.hubitat.app.DeviceWrapper cd, level, transitionTime = null ) { // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 167
	if (cd.hasCapability("FanControl") ) { // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 168
			setSpeed(cd:cd, level:level, speed:levelToSpeed((Integer) level )) // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 169
		} else {  // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 170
			setLevel(level:level, duration:transitionTime, cd:cd)  // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 171
		} // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 172
} // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 173

void setLevel(level, duration = null ) { // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 175
	setLevel(level:level, duration:duration) // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 176
} // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 177

void setLevel(Map params = [cd: null , level: null , duration: null ]) // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 179
{ // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 180
	if ( (params.level as Integer) <= 0) { // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 181
		off(cd:params.cd, duration:params.duration) // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 182
	} else { // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 183
		on(cd:params.cd, level:params.level, duration:params.duration) // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 184
	} // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 185
} // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 186


void componentStartLevelChange(com.hubitat.app.DeviceWrapper cd, direction) { startLevelChange(direction, cd) } // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 189
void startLevelChange(direction, cd = null ){ // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 190
	com.hubitat.app.DeviceWrapper targetDevice = (cd ? cd : device) // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 191
	Integer ep = cd ? (cd.deviceNetworkId.split("-ep")[-1] as Integer) : null // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 192

    Integer upDown = (direction == "down") ? 1 : 0 // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 194

	def sendMe = zwave.switchMultilevelV1.switchMultilevelStartLevelChange(upDown: upDown, ignoreStartLevel: 1, startLevel: 0) // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 196

    advancedZwaveSend(sendMe, ep) // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 198
} // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 199



void componentStopLevelChange(com.hubitat.app.DeviceWrapper cd) { stopLevelChange(cd) } // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 203
void stopLevelChange(cd = null ){ // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 204
	com.hubitat.app.DeviceWrapper targetDevice = (cd ? cd : device) // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 205
	Integer ep = cd ? (cd.deviceNetworkId.split("-ep")[-1] as Integer) : null // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 206

	advancedZwaveSend(zwave.switchMultilevelV4.switchMultilevelStopLevelChange(), ep) // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 208
	advancedZwaveSend(zwave.basicV1.basicGet(), ep) // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 209
} // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 210

//////////////////////////////////////////////////////// // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 212
//////                Handle Fans                /////// // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 213
//////////////////////////////////////////////////////// // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 214

String levelToSpeed(Integer level) // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 216
{ // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 217
// 	Map speeds = [(0..0):"off", (1..20):"low", (21..40):"medium-low", (41-60):"medium", (61..80):"medium-high", (81..100):"high"] // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 218
//	return (speeds.find{ key, value -> key.contains(level) }).value // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 219
	switch (level) // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 220
	{ // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 221
	case 0 : 		return "off" ; break // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 222
	case 1..20: 	return "low" ; break // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 223
	case 21..40: 	return "medium-low" ; break // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 224
	case 41..60: 	return "medium" ; break // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 225
	case 61..80: 	return "medium-high" ; break // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 226
	case 81..100: 	return "high" ; break // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 227
	default : return null // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 228
	} // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 229
} // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 230

Integer speedToLevel(String speed) { // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 232
	return ["off": 0, "low":20, "medium-low":40, "medium":60, "medium-high":80, "high":100].get(speed) // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 233
} // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 234

void componentSetSpeed(com.hubitat.app.DeviceWrapper cd, speed) { setSpeed(speed:speed, cd:cd) } // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 236
void setSpeed(speed, com.hubitat.app.DeviceWrapper cd = null ) { setSpeed(speed:speed, cd:cd) } // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 237
void setSpeed(Map params = [speed: null , level: null , cd: null ]) // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 238
{ // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 239
	com.hubitat.app.DeviceWrapper originatingDevice = params.cd ?: device // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 240
	Integer ep = params.cd ? (originatingDevice.deviceNetworkId.split("-ep")[-1] as Integer) : 0 // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 241

	List<com.hubitat.app.DeviceWrapper> targetDevices = getChildDeviceListByEndpoint(ep) // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 243

	if (params.speed.is( null ) ) { // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 245
		log.error "Device ${originatingDevice.displayName}: setSpeed command received without a valid speed setting. Speed setting was ${params.speed}. Returning without doing anything!" // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 246
		return // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 247
	} // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 248

    if (logEnable) log.info "Device ${device.displayName}: received setSpeed(${params.speed}) request from child ${targetDevice.displayName}" // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 250

	String currentOnState = originatingDevice.currentValue("switch") // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 252
	Integer currentLevel = originatingDevice.currentValue("level") // Null if attribute isn't supported. // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 253
	Integer targetLevel // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 254

	if (params.speed == "on") // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 256
	{ // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 257
		currentLevel = currentLevel ?: 100 // If it was a a level of 0, turn to 100%. Level should never be 0 -- except it might be 0 or null on first startup! // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 258

		targetDevices.each{ // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 260
			it.sendEvent(name: "switch", value: "on", descriptionText: "Fan turned on", type: "digital") // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 261
			it.sendEvent(name: "level", value: currentLevel, descriptionText: "Fan level set", unit:"%", type: "digital") // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 262
			it.sendEvent(name: "speed", value: levelToSpeed(currentLevel), descriptionText: "Fan speed set", type: "digital") // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 263
		} // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 264
		sendZwaveValue(value: currentLevel, duration: 0, ep: ep) // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 265

	} else if (params.speed == "off") // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 267
	{  // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 268
		targetDevices.each{ // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 269
			it.sendEvent(name: "switch", value: "off", descriptionText: "Fan switched off", type: "digital") // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 270
			it.sendEvent(name: "speed", value: "off", descriptionText: "Fan speed set", type: "digital") // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 271
		}			 // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 272

		sendZwaveValue(value: 0, duration: 0, ep: ep) // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 274

	} else { // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 276
		targetLevel = (params.level as Integer) ?: speedToLevel(params.speed) ?: currentLevel // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 277
		targetDevices.each{ // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 278
			it.sendEvent(name: "switch", value: "on", descriptionText: "Fan turned on", type: "digital") // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 279
			it.sendEvent(name: "speed", value: params.speed, descriptionText: "Fan speed set", type: "digital") // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 280
			it.sendEvent(name: "level", value: targetLevel, descriptionText: "Fan level set", unit:"%", type: "digital") // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 281
		} // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 282
		sendZwaveValue(value: targetLevel, duration: 0, ep: ep) // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 283
	} // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 284
} // library marker zwaveTools.binaryAndMultilevelDeviceTools, line 285
...
void zwaveEvent(hubitat.zwave.commands.centralscenev3.CentralSceneSupportedReport  cmd) { // library marker zwaveTools.centralSceneTools, line 41
	sendEventToAll(event:[name:"numberOfButtons", value: cmd.supportedScenes]) // library marker zwaveTools.centralSceneTools, line 42
} // library marker zwaveTools.centralSceneTools, line 43
...
void hold(button) 		{ sendEventToAll(event:[name:"held", value:button, type:"digital", isStateChange: true ]      )} // library marker zwaveTools.centralSceneTools, line 49
void release(button) 	{ sendEventToAll(event:[name:"released", value:button, type:"digital", isStateChange: true ] )} // library marker zwaveTools.centralSceneTools, line 50

void multiTap(button, taps) { // library marker zwaveTools.centralSceneTools, line 52
	if (taps == 1) { // library marker zwaveTools.centralSceneTools, line 53
	    sendEventToAll(event:[name:"pushed", value:button, type:"digital", isStateChange: true ])	 // library marker zwaveTools.centralSceneTools, line 54
	} else if (taps == 2) { // library marker zwaveTools.centralSceneTools, line 55
		sendEventToAll(event:[name:"doubleTapped", value:button, type:"digital", isStateChange: true ])	 // library marker zwaveTools.centralSceneTools, line 56
	} // library marker zwaveTools.centralSceneTools, line 57

    sendEventToAll(event:[name:"multiTapButton", value:("${button}.${taps}" as Float), type:"physical", unit:"Button #.Tap Count", isStateChange: true ])		 // library marker zwaveTools.centralSceneTools, line 59
} // library marker zwaveTools.centralSceneTools, line 60

void zwaveEvent(hubitat.zwave.commands.centralscenev3.CentralSceneNotification cmd) // library marker zwaveTools.centralSceneTools, line 62
{ // library marker zwaveTools.centralSceneTools, line 63

	// Check if central scene is already in a held state, if so, and you get another held message, its a refresh, so don't send a sendEvent // library marker zwaveTools.centralSceneTools, line 65
	if ((getCentralSceneButtonState((Integer)cmd.sceneNumber) == "held") && (((Integer) cmd.keyAttributes) == 2)) return // library marker zwaveTools.centralSceneTools, line 66

	// Central scene events should be sent with isStateChange:true since it is valid to send two of the same events in a row (except held, whcih is handled in previous line) // library marker zwaveTools.centralSceneTools, line 68
    Map event = [value:cmd.sceneNumber, type:"physical", unit:"button#", isStateChange:true] // library marker zwaveTools.centralSceneTools, line 69

	event.name = [	0:"pushed", 1:"released", 2:"held",  3:"doubleTapped",  // library marker zwaveTools.centralSceneTools, line 71
					4:"buttonTripleTapped", 5:"buttonFourTaps", 6:"buttonFiveTaps"].get((Integer)cmd.keyAttributes) // library marker zwaveTools.centralSceneTools, line 72

	String tapDescription = [	0:"Pushed", 1:"Released", 2:"Held",  3:"Double-Tapped",  // library marker zwaveTools.centralSceneTools, line 74
								4:"Three Taps", 5:"Four Taps", 6:"Five Taps"].get((Integer)cmd.keyAttributes) // library marker zwaveTools.centralSceneTools, line 75

	// Save the event name for event that is about to be sent using sendEvent. This is important for 'held' state refresh checking // library marker zwaveTools.centralSceneTools, line 77
	setCentralSceneButtonState((Integer) cmd.sceneNumber , event.name)	 // library marker zwaveTools.centralSceneTools, line 78

	event.descriptionText="${device.displayName}: Button #${cmd.sceneNumber}: ${tapDescription}" // library marker zwaveTools.centralSceneTools, line 80

	sendEventToAll(event:event) // library marker zwaveTools.centralSceneTools, line 82

	// Next code is for the custom attribute "multiTapButton". // library marker zwaveTools.centralSceneTools, line 84
	Integer taps = [0:1, 3:2, 4:3, 5:4, 6:5].get((Integer)cmd.keyAttributes) // library marker zwaveTools.centralSceneTools, line 85
	if ( taps) // library marker zwaveTools.centralSceneTools, line 86
	{ // library marker zwaveTools.centralSceneTools, line 87
		event.name = "multiTapButton" // library marker zwaveTools.centralSceneTools, line 88
		event.unit = "Button.Taps" // library marker zwaveTools.centralSceneTools, line 89
		event.value = ("${cmd.sceneNumber}.${taps}" as Float) // library marker zwaveTools.centralSceneTools, line 90
		sendEventToAll(event:event) // library marker zwaveTools.centralSceneTools, line 91
	}  // library marker zwaveTools.centralSceneTools, line 92
} // library marker zwaveTools.centralSceneTools, line 93
...
String getChildNetID(Integer ep, Integer index){ // library marker zwaveTools.childDeviceTools, line 32
	return "${device.deviceNetworkId}.child${index}-ep${"${ep}".padLeft(3, "0") }" // library marker zwaveTools.childDeviceTools, line 33
} // library marker zwaveTools.childDeviceTools, line 34

void createChildDevices() // library marker zwaveTools.childDeviceTools, line 36
{	 // library marker zwaveTools.childDeviceTools, line 37
	getFullEndpointRecord()?.each // library marker zwaveTools.childDeviceTools, line 38
	{ ep, endpointRecord -> // library marker zwaveTools.childDeviceTools, line 39

		endpointRecord.children?.eachWithIndex { thisChildItem, index -> // library marker zwaveTools.childDeviceTools, line 41
			String childNetworkId = getChildNetID(ep, index) // library marker zwaveTools.childDeviceTools, line 42
			com.hubitat.app.DeviceWrapper cd = getChildDevice(childNetworkId) // library marker zwaveTools.childDeviceTools, line 43
			if (cd.is( null )) { // library marker zwaveTools.childDeviceTools, line 44
				log.info "Device ${device.displayName}: creating child device: ${childNetworkId} with driver ${thisChildItem.type} and namespace: ${thisChildItem.namespace}." // library marker zwaveTools.childDeviceTools, line 45

				addChildDevice(thisChildItem.namespace, thisChildItem.type, childNetworkId, [name: thisChildItem.childName ?: childNetworkId, isComponent: false]) // library marker zwaveTools.childDeviceTools, line 47
...
} // library marker zwaveTools.childDeviceTools, line 51
// // library marker zwaveTools.childDeviceTools, line 52
		command "addNewChildDevice", [[name:"Device Name*", type:"STRING"],  // library marker zwaveTools.childDeviceTools, line 53
                                      [name:"componentDriverName*",type:"ENUM", constraints:(getDriverChoices()) ],  // library marker zwaveTools.childDeviceTools, line 54
                                      [name:"Endpoint",type:"NUMBER", description:"Endpoint Number, blank or 0 = root" ] ] // library marker zwaveTools.childDeviceTools, line 55

// // library marker zwaveTools.childDeviceTools, line 57

List getDriverChoices() { // library marker zwaveTools.childDeviceTools, line 59
	// Returns the name of the generic component drivers with their namespace listed in parenthesis // library marker zwaveTools.childDeviceTools, line 60
    // log.debug getInstalledDrivers().findAll{it.name.toLowerCase().startsWith("generic component")}.collect{ "${it.name} (${it.namespace})"}.sort() // library marker zwaveTools.childDeviceTools, line 61
    return getInstalledDrivers().findAll{it.name.toLowerCase().startsWith("generic component")}.collect{ "${it.name} (${it.namespace})"}.sort() // library marker zwaveTools.childDeviceTools, line 62
} // library marker zwaveTools.childDeviceTools, line 63

String getChildNetworkId(Integer ep) // library marker zwaveTools.childDeviceTools, line 65
{ // library marker zwaveTools.childDeviceTools, line 66
	Integer thisChild = 1 // library marker zwaveTools.childDeviceTools, line 67
	String rValue = "${device.displayName}.Child${thisChild}-ep${ep ?: 0}" // library marker zwaveTools.childDeviceTools, line 68
	while ( getChildDevice(rValue) ) { thisChild ++ } // library marker zwaveTools.childDeviceTools, line 69
	return rValue // library marker zwaveTools.childDeviceTools, line 70
} // library marker zwaveTools.childDeviceTools, line 71
void addNewChildDevice(String newChildName, String componentDriverName, endpoint) { // library marker zwaveTools.childDeviceTools, line 72
	// log.debug "Driver name is ${newChildName} with driver component type ${componentDriverName} for endpoint ${endpoint}" // library marker zwaveTools.childDeviceTools, line 73
	Map thisDriver = getInstalledDrivers().find{ "${it.name} (${it.namespace})" == componentDriverName } // library marker zwaveTools.childDeviceTools, line 74

	// log.debug "selected driver is ${thisDriver}" // library marker zwaveTools.childDeviceTools, line 76
	String thisChildNetworkId = getChildNetworkId((int) endpoint) // library marker zwaveTools.childDeviceTools, line 77
	addChildDevice(thisDriver.namespace, thisDriver.name, thisChildNetworkId, [name: newChildName, isComponent: false]) // library marker zwaveTools.childDeviceTools, line 78
} // library marker zwaveTools.childDeviceTools, line 79

///////////////////////////////////////////////////////////////// // library marker zwaveTools.childDeviceTools, line 81
...
{ // library marker zwaveTools.parameterManagementTools, line 19
	...
	// if (logEnable ) log.debug "Device ${device.displayName}: Current input control values are: ${settingValueMap}" // library marker zwaveTools.parameterManagementTools, line 33

	// Find what changed // library marker zwaveTools.parameterManagementTools, line 35
	settingValueMap.findAll{k, v -> !(v.is( null ))}.each {k, v -> // library marker zwaveTools.parameterManagementTools, line 36
			Boolean changedValue = ((v as BigInteger) != (parameterValueMap.get(k as Integer) as BigInteger))  // library marker zwaveTools.parameterManagementTools, line 37
			if (changedValue) { // library marker zwaveTools.parameterManagementTools, line 38
				pendingChanges?.put(k as Integer, v as BigInteger) // library marker zwaveTools.parameterManagementTools, line 39
			} else pendingChanges?.remove(k) // library marker zwaveTools.parameterManagementTools, line 40
		} // library marker zwaveTools.parameterManagementTools, line 41

	if (txtEnable) log.info "Device ${device.displayName}: Pending parameter changes are: ${pendingChanges ?: "None"}" // library marker zwaveTools.parameterManagementTools, line 43

	processPendingChanges() // library marker zwaveTools.parameterManagementTools, line 45
	if (txtEnable) log.info "Device ${device.displayName}: Done updating changed parameters (if any) . . ." // library marker zwaveTools.parameterManagementTools, line 46

} // library marker zwaveTools.parameterManagementTools, line 48

void processPendingChanges() // library marker zwaveTools.parameterManagementTools, line 50
{ // library marker zwaveTools.parameterManagementTools, line 51
	if (txtEnable) log.info "Device ${device.displayName}: Processing Pending parameter changes: ${getPendingChangeMap()}" // library marker zwaveTools.parameterManagementTools, line 52
		pendingChangeMap?.findAll{k, v -> !(v.is( null ))}.each{ k, v -> // library marker zwaveTools.parameterManagementTools, line 53
			if (txtEnable) log.info "Updating parameter ${k} to value ${v}" // library marker zwaveTools.parameterManagementTools, line 54
			setParameter(parameterNumber: k , value: v) // library marker zwaveTools.parameterManagementTools, line 55
		} // library marker zwaveTools.parameterManagementTools, line 56
} // library marker zwaveTools.parameterManagementTools, line 57

void setParameter(parameterNumber, value = null ) { // library marker zwaveTools.parameterManagementTools, line 59
	if (parameterNumber && ( ! value.is( null ) )) { // library marker zwaveTools.parameterManagementTools, line 60
		setParameter(parameterNumber:parameterNumber, value:value) // library marker zwaveTools.parameterManagementTools, line 61
	} else if (parameterNumber) { // library marker zwaveTools.parameterManagementTools, line 62
		advancedZwaveSend( zwave.configurationV1.configurationGet(parameterNumber: parameterNumber)) // library marker zwaveTools.parameterManagementTools, line 63
		hubitat.zwave.Command report = myReportQueue("7006").poll(5, TimeUnit.SECONDS) // library marker zwaveTools.parameterManagementTools, line 64
		if (logEnable) log.debug "Device ${device.displayName}: Received a parameter configuration report: ${report}." // library marker zwaveTools.parameterManagementTools, line 65
	} // library marker zwaveTools.parameterManagementTools, line 66
} // library marker zwaveTools.parameterManagementTools, line 67

Boolean setParameter(Map params = [parameterNumber: null , value: null ] ){ // library marker zwaveTools.parameterManagementTools, line 69
    if (params.parameterNumber.is( null ) || params.value.is( null ) ) { // library marker zwaveTools.parameterManagementTools, line 70
		log.warn "Device ${device.displayName}: Can't set parameter ${parameterNumber}, Incomplete parameter list supplied... syntax: setParameter(parameterNumber,size,value), received: setParameter(${parameterNumber}, ${size}, ${value})." // library marker zwaveTools.parameterManagementTools, line 71
		return false // library marker zwaveTools.parameterManagementTools, line 72
    }  // library marker zwaveTools.parameterManagementTools, line 73

	String getThis = "${params.parameterNumber}" as String // library marker zwaveTools.parameterManagementTools, line 75

	Integer PSize = ( deviceInputs.get(getThis)?.size) ?: (deviceInputs.get(params.parameterNumber as Integer)?.size ) // library marker zwaveTools.parameterManagementTools, line 77

	if (!PSize) {log.error "Device ${device.displayName}: Could not get parameter size in function setParameter. Defaulting to 1"; PSize = 1} // library marker zwaveTools.parameterManagementTools, line 79

	advancedZwaveSend(zwave.configurationV1.configurationSet(scaledConfigurationValue: params.value as BigInteger, parameterNumber: params.parameterNumber, size: PSize)) // library marker zwaveTools.parameterManagementTools, line 81
	// The 'get' should not be supervised! // library marker zwaveTools.parameterManagementTools, line 82
	advancedZwaveSend( zwave.configurationV1.configurationGet(parameterNumber: params.parameterNumber)) // library marker zwaveTools.parameterManagementTools, line 83

	// Wait for the report that is returned after the configurationGet, and then update the input controls so they display the updated value. // library marker zwaveTools.parameterManagementTools, line 85
	Boolean success = myReportQueue("7006").poll(5, TimeUnit.SECONDS) ? true : false  // library marker zwaveTools.parameterManagementTools, line 86

} // library marker zwaveTools.parameterManagementTools, line 88

// Gets a map of all the values currently stored in the input controls. // library marker zwaveTools.parameterManagementTools, line 90
Map<Integer, BigInteger> getParameterValuesFromInputControls() // library marker zwaveTools.parameterManagementTools, line 91
{ // library marker zwaveTools.parameterManagementTools, line 92
	ConcurrentHashMap inputs = getDeviceInputs() // library marker zwaveTools.parameterManagementTools, line 93

	if (!inputs) return // library marker zwaveTools.parameterManagementTools, line 95

	Map<Integer, BigInteger> settingValues = [:] // library marker zwaveTools.parameterManagementTools, line 97

	inputs.each  // library marker zwaveTools.parameterManagementTools, line 99
		{ PKey , PData ->  // library marker zwaveTools.parameterManagementTools, line 100
			BigInteger newValue = 0 // library marker zwaveTools.parameterManagementTools, line 101
			// if the setting returns an array, then it is a bitmap control, and add together the values. // library marker zwaveTools.parameterManagementTools, line 102

			if (settings.get(PData.name as String) instanceof ArrayList) { // library marker zwaveTools.parameterManagementTools, line 104
				settings.get(PData.name as String).each{ newValue += it as BigInteger } // library marker zwaveTools.parameterManagementTools, line 105
			} else  {    // library marker zwaveTools.parameterManagementTools, line 106
				newValue = settings.get(PData.name as String) as BigInteger   // library marker zwaveTools.parameterManagementTools, line 107
			} // library marker zwaveTools.parameterManagementTools, line 108
			settingValues.put(PKey, newValue) // library marker zwaveTools.parameterManagementTools, line 109
		} // library marker zwaveTools.parameterManagementTools, line 110
	if (txtEnable) log.info "Device ${device.displayName}: Current Parameter Setting Values are: " + settingValues // library marker zwaveTools.parameterManagementTools, line 111
	return settingValues // library marker zwaveTools.parameterManagementTools, line 112
} // library marker zwaveTools.parameterManagementTools, line 113

@Field static  ConcurrentHashMap<String, ConcurrentHashMap> allPendingParameterChanges = new ConcurrentHashMap<String, ConcurrentHashMap>(128, 0.75, 1) // library marker zwaveTools.parameterManagementTools, line 115
@Field static  ConcurrentHashMap<String, ConcurrentHashMap> allDevicesParameterValues = new ConcurrentHashMap<String, ConcurrentHashMap>(128, 0.75, 1) // library marker zwaveTools.parameterManagementTools, line 116

ConcurrentHashMap getPendingChangeMap() { // library marker zwaveTools.parameterManagementTools, line 118
	return  allPendingParameterChanges.get(device.deviceNetworkId, new ConcurrentHashMap(32, 0.75, 1) ) // library marker zwaveTools.parameterManagementTools, line 119
} // library marker zwaveTools.parameterManagementTools, line 120

Map<Integer, BigInteger> getParameterValuesFromDevice() // library marker zwaveTools.parameterManagementTools, line 122
{ // library marker zwaveTools.parameterManagementTools, line 123
	ConcurrentHashMap parameterValues = allDevicesParameterValues.get(device.deviceNetworkId, new ConcurrentHashMap<Integer, BigInteger>(32, 0.75, 1)) // library marker zwaveTools.parameterManagementTools, line 124

	ConcurrentHashMap inputs = getDeviceInputs()	 // library marker zwaveTools.parameterManagementTools, line 126

	log.debug "In function getParameterValuesFromDevice, parameter values are: ${parameterValues}. Size is: ${parameterValues.size()}. Inputs size is ${inputs.size()}." // library marker zwaveTools.parameterManagementTools, line 128

	if (!inputs) return null // library marker zwaveTools.parameterManagementTools, line 130

	if ((parameterValues?.size() as Integer) == (inputs?.size() as Integer) )  // library marker zwaveTools.parameterManagementTools, line 132
	{ // library marker zwaveTools.parameterManagementTools, line 133
		// if (logEnable) log.debug "Device ${device.displayName}: In Function getParameterValuesFromDevice, returning Previously retrieved Parameter values: ${parameterValues}" // library marker zwaveTools.parameterManagementTools, line 134

		return parameterValues // library marker zwaveTools.parameterManagementTools, line 136
	} else { // library marker zwaveTools.parameterManagementTools, line 137
		// if (logEnable) log.debug "Getting missing parameter values" // library marker zwaveTools.parameterManagementTools, line 138
		Integer waitTime = 1 // library marker zwaveTools.parameterManagementTools, line 139
		inputs.eachWithIndex  // library marker zwaveTools.parameterManagementTools, line 140
			{ k, v, i -> // library marker zwaveTools.parameterManagementTools, line 141
				if (parameterValues.get(k as Integer).is( null ) ) { // library marker zwaveTools.parameterManagementTools, line 142
					if (txtEnable) log.info "Device ${device.displayName}: Obtaining value from Zwave device for parameter # ${k}" // library marker zwaveTools.parameterManagementTools, line 143
					advancedZwaveSend(zwave.configurationV2.configurationGet(parameterNumber: k)) // library marker zwaveTools.parameterManagementTools, line 144
						// Wait 2 second for most of the reports, but wait up to 10 seconds for the last one. // library marker zwaveTools.parameterManagementTools, line 145
						waitTime = (i >= (inputs.size() -1 )) ? 10 : 2 // library marker zwaveTools.parameterManagementTools, line 146
						myReportQueue("7006").poll(waitTime, TimeUnit.SECONDS) // library marker zwaveTools.parameterManagementTools, line 147

				} else { // library marker zwaveTools.parameterManagementTools, line 149
					if (logEnable) log.debug "Device ${device.displayName}: For parameter: ${k} previously retrieved a value of ${parameterValues.get(k as Integer)}." // library marker zwaveTools.parameterManagementTools, line 150
				} // library marker zwaveTools.parameterManagementTools, line 151
			} // library marker zwaveTools.parameterManagementTools, line 152
		return parameterValues			 // library marker zwaveTools.parameterManagementTools, line 153
	} // library marker zwaveTools.parameterManagementTools, line 154
	return null // library marker zwaveTools.parameterManagementTools, line 155
} // library marker zwaveTools.parameterManagementTools, line 156

void zwaveEvent(hubitat.zwave.commands.configurationv2.ConfigurationReport  cmd) // library marker zwaveTools.parameterManagementTools, line 158
{  // library marker zwaveTools.parameterManagementTools, line 159
	if (logEnable) log.debug "Device ${device.displayName}: Received a configuration report ${cmd}." // library marker zwaveTools.parameterManagementTools, line 160
	ConcurrentHashMap parameterValues = allDevicesParameterValues.get(device.deviceNetworkId, new ConcurrentHashMap<Integer, BigInteger>(32, 0.75, 1)) // library marker zwaveTools.parameterManagementTools, line 161
	BigInteger newValue = (cmd.size == 1) ? cmd.configurationValue[0] : cmd.scaledConfigurationValue			 // library marker zwaveTools.parameterManagementTools, line 162
	if (newValue < 0) log.warn "Device ${device.displayName}: Negative configuration value reported for configuration parameter ${cmd.parameterNumber}." // library marker zwaveTools.parameterManagementTools, line 163

	parameterValues.put((cmd.parameterNumber as Integer), newValue ) // library marker zwaveTools.parameterManagementTools, line 165

	pendingChangeMap.remove(cmd.parameterNumber as Integer) // library marker zwaveTools.parameterManagementTools, line 167

	if (txtEnable) log.info "Device ${device.displayName}: updating parameter: ${cmd.parameterNumber} to ${newValue}." // library marker zwaveTools.parameterManagementTools, line 169
	device.updateSetting("${cmd.parameterNumber}", newValue as Integer) // library marker zwaveTools.parameterManagementTools, line 170

	myReportQueue(cmd.CMD).offer( cmd ) // library marker zwaveTools.parameterManagementTools, line 172
} // library marker zwaveTools.parameterManagementTools, line 173

////////////////////////////////////////////////////////////////////// // library marker zwaveTools.parameterManagementTools, line 175
//////                  Report Queues                          /////// // library marker zwaveTools.parameterManagementTools, line 176
////////////////////////////////////////////////////////////////////// // library marker zwaveTools.parameterManagementTools, line 177
// reportQueues stores a map of SynchronousQueues. When requesting a report from a device, the report handler communicates the report back to the requesting function using a queue. This makes programming more like "synchronous" programming, rather than asynchronous handling. // library marker zwaveTools.parameterManagementTools, line 178
// This is a map within a map. The first level map is by deviceNetworkId. Since @Field static variables are shared among all devices using the same driver code, this ensures that you get a unique second-level map for a particular device. The second map is keyed by the report class hex string. For example, if you want to wait for the configurationGet report, wait for "7006". // library marker zwaveTools.parameterManagementTools, line 179
@Field static reportQueues = new ConcurrentHashMap<String, ConcurrentHashMap>(128, 0.75, 1) // library marker zwaveTools.parameterManagementTools, line 180

SynchronousQueue myReportQueue(String reportClass) { // library marker zwaveTools.parameterManagementTools, line 182
	ConcurrentHashMap thisDeviceQueues = reportQueues.get(device.deviceNetworkId, new ConcurrentHashMap<String,SynchronousQueue>(32, 0.75, 1)) // library marker zwaveTools.parameterManagementTools, line 183

	// Get the queue if it exists, create (new) it if it does not. // library marker zwaveTools.parameterManagementTools, line 185
	SynchronousQueue thisReportQueue = thisDeviceQueues.get(reportClass, new SynchronousQueue()) // library marker zwaveTools.parameterManagementTools, line 186
	return thisReportQueue // library marker zwaveTools.parameterManagementTools, line 187
} // library marker zwaveTools.parameterManagementTools, line 188
